...
namespace SSC {
  ...
  class Core {
    ...
    public:
      ...
      void bufferSize (String seq, uint64_t peerId, int size, int buffer, Cb cb) const;
  ...
  void Core::bufferSize (String seq, uint64_t peerId, int size, int buffer, Cb cb) const {
