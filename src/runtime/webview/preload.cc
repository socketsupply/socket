...
namespace ssc::runtime::webview {
  ...
  void Preload::configure (const Options& options) {
    ...
    if (runtime::env::has("SOCKET_RUNTIME_VM_DEBUG")) {
      this->options.env["SOCKET_RUNTIME_VM_DEBUG"] = runtime::env::get("SOCKET_RUNTIME_VM_DEBUG");
    }

    if (runtime::env::has("SOCKET_RUNTIME_NPM_DEBUG")) {
      this->options.env["SOCKET_RUNTIME_NPM_DEBUG"] = runtime::env::get("SOCKET_RUNTIME_NPM_DEBUG");
    }

    if (runtime::env::has("SOCKET_RUNTIME_SHARED_WORKER_DEBUG")) {
      this->options.env["SOCKET_RUNTIME_SHARED_WORKER_DEBUG"] = runtime::env::get("SOCKET_RUNTIME_SHARED_WORKER_DEBUG");
    }

    if (runtime::env::has("SOCKET_RUNTIME_SERVICE_WORKER_DEBUG")) {
      this->options.env["SOCKET_RUNTIME_SERVICE_WORKER_DEBUG"] = runtime::env::get("SOCKET_RUNTIME_SERVICE_WORKER_DEBUG");
    }
  }
