...
# [application](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L14)
...
## [MAX_WINDOWS](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L62)

This is a `VariableDeclaration` named `MAX_WINDOWS` in `api/application.js`, it's exported but undocumented.


## [ApplicationWindowList](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L64)

This is a `ClassDeclaration` named `ApplicationWindowList` in `api/application.js`, it's exported but undocumented.


## [`addEventListener(type, listener, |boolean)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L191)
...
## [`removeEventListener(type, listener)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L200)
...
## [`getCurrentWindowIndex()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L208)
...
## [`createWindow(opts)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L243)
...
### [`radius()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L270)



### [`margin()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L275)



## [`getScreenSize()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L363)
...
## [`getWindows(indices)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L394)
...
## [`getWindow(index)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L448)
...
## [`getCurrentWindow()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L458)
...
## [`exit(code)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L467)
...
## [`setSystemMenu(options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L564)
...
## [`setTrayMenu()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L571)

An alias to setSystemMenu for creating a tary menu

## [`setSystemMenuItemEnabled(value)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L580)
...
## [`isPaused()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L588)
...
## [runtimeVersion](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L596)

Socket Runtime version.

## [debug](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L602)

Runtime debug flag.

## [config](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L608)

Application configuration.

## [backend](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L613)

The application's backend instance.

### [`open(opts)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L619)
...
### [`close()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/application.js#L627)
...
# [bluetooth](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/bluetooth.js#L12)
...
## [`Bluetooth` (extends `EventEmitter`)](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/bluetooth.js#L32)

Create an instance of a Bluetooth service.

### [`constructor(serviceId)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/bluetooth.js#L40)
...
### [`start()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/bluetooth.js#L90)
...
### [`subscribe(id)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/bluetooth.js#L119)
...
### [`publish(id, value)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/bluetooth.js#L142)
...
# [crypto](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/crypto.js#L15)
...
## [webcrypto](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/crypto.js#L30)

External docs: https://developer.mozilla.org/en-US/docs/Web/API/Crypto
WebCrypto API

## [ready](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/crypto.js#L59)

A promise that resolves when all internals to be loaded/ready.

## [`getRandomValues(buffer)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/crypto.js#L74)
...
## [`rand64()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/crypto.js#L97)
...
## [RANDOM_BYTES_QUOTA](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/crypto.js#L105)

Maximum total size of random bytes per page

## [MAX_RANDOM_BYTES](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/crypto.js#L110)

Maximum total size for random bytes.

## [MAX_RANDOM_BYTES_PAGES](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/crypto.js#L115)

Maximum total amount of allocated per page of bytes (max/quota)

## [`randomBytes(size)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/crypto.js#L123)
...
## [`createDigest(algorithm, message)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/crypto.js#L150)
...
## [`murmur3(value, seed)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/crypto.js#L161)
...
# [dgram](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L13)
...
## [`createSocket(options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L662)
...
## [`Socket` (extends `EventEmitter`)](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L668)

New instances of dgram.Socket are created using dgram.createSocket().
 The new keyword is not to be used to create dgram.Socket instances.

### [`bind(port, address, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L752)
...
### [`connect(port, host, connectListener)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L873)
...
### [`disconnect()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L910)
...
### [`send(msg, offset, length, port, address, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L969)
...
### [`close(callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L1067)
...
### [`address()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L1143)
...
### [`remoteAddress()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L1178)
...
### [`setRecvBufferSize(size)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L1209)
...
### [`setSendBufferSize(size)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L1226)
...
### [`getRecvBufferSize()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L1239)

External docs: https://nodejs.org/api/dgram.html#socketgetrecvbuffersize


### [`getSendBufferSize()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L1247)
...
### [`code()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L1315)



## [`ERR_SOCKET_ALREADY_BOUND` (extends `SocketError`)](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L1321)

Thrown when a socket is already bound.

## [`ERR_SOCKET_DGRAM_IS_CONNECTED` (extends `SocketError`)](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L1338)

Thrown when the socket is already connected.

## [`ERR_SOCKET_DGRAM_NOT_CONNECTED` (extends `SocketError`)](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L1345)

Thrown when the socket is not connected.

## [`ERR_SOCKET_DGRAM_NOT_RUNNING` (extends `SocketError`)](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L1353)

Thrown when the socket is not running (not bound or connected).

## [`ERR_SOCKET_BAD_TYPE` (extends `TypeError`)](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L1360)

Thrown when a bad socket type is used in an argument.

## [`ERR_SOCKET_BAD_PORT` (extends `RangeError`)](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dgram.js#L1370)
...
# [dns](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dns/index.js#L17)
...
## [`lookup(hostname, options, cb)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dns/index.js#L60)
...
# [dns.promises](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dns/promises.js#L17)
...
## [`lookup(hostname, opts)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/dns/promises.js#L37)
...
# [fs](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L26)
...
## [`access(path, mode, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L111)
...
## [`accessSync(path, mode)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L143)
...
## [`exists(path, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L160)
...
## [`existsSync(path, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L177)
...
## [`chmod(path, mode, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L197)
...
## [`chmodSync(path, mode)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L232)
...
## [`chown(path, uid, gid, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L256)
...
## [`chownSync(path, uid, gid)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L294)
...
## [`close(fd, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L321)
...
## [`closeSync(fd)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L341)
...
## [`copyFile(src, dest, flags, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L358)
...
## [`copyFileSync(src, dest, flags)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L401)
...
## [`createReadStream(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L430)
...
## [`createWriteStream(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L475)
...
## [`fstat(fd, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L529)
...
## [`fsync(fd, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L556)
...
## [`ftruncate(fd, offset, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L578)
...
## [`lchown(path, uid, gid, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L606)
...
## [`link(src, dest, )`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L645)
...
## [`open(path, flags, mode, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L733)
...
## [`openSync(path, flags, mode, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L786)
...
## [`opendir(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L833)
...
## [`opendirSync(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L860)
...
## [`read(fd, buffer, offset, length, position, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L887)
...
## [`write(fd, buffer, offset, length, position, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L922)
...
## [`readdir(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L956)
...
## [`readdirSync(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1008)
...
## [`readFile(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1038)
...
## [`readFileSync(path, } options, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1080)
...
## [`readlink(path, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1143)
...
## [`realpath(path, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1163)
...
## [`realpathSync(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1181)
...
## [`rename(src, dest, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1199)
...
## [`renameSync(src, dest)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1225)
...
## [`rmdir(path, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1249)
...
## [`rmdirSync(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1269)
...
## [`statSync(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1290)
...
## [`stat(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1310)
...
## [`lstat(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1382)
...
## [`symlink(src, dest)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1423)
...
## [`unlink(path, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1466)
...
## [`unlinkSync(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1486)
...
## [`writeFile(path, data, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1511)
...
## [`writeFileSync(path, data, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1556)
...
## [`watch(, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/index.js#L1591)
...
# [fs.promises](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L25)
...
## [`access(path, mode, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L111)
...
## [`chmod(path, mode)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L122)
...
## [`chown(path, uid, gid)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L147)
...
## [`copyFile(src, dest, flags)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L176)
...
## [`lchown(path, uid, gid)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L206)
...
## [`link(src, dest)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L234)
...
## [`mkdir(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L262)
...
## [`open(path, flags, mode)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L292)
...
## [`opendir(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L305)
...
## [`readdir(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L318)
...
## [`readFile(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L356)
...
## [`readlink(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L374)
...
## [`realpath(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L395)
...
## [`rename(src, dest)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L417)
...
## [`rmdir(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L441)
...
## [`stat(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L463)
...
## [`lstat(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L478)
...
## [`symlink(src, dest)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L491)
...
## [`unlink(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L527)
...
## [`writeFile(path, data, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L552)
...
## [`watch(, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/fs/promises.js#L573)
...
# [ipc](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/ipc.js#L37)
...
## [`maybeMakeError()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/ipc.js#L281)

This is a `FunctionDeclaration` named `maybeMakeError` in `api/ipc.js`, it's exported but undocumented.


### [debug](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/ipc.js#L408)



### [undefined](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/ipc.js#L408)
...
## [`IPCSearchParams` (extends `URLSearchParams`)](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/ipc.js#L1050)

This is a `ClassDeclaration` named ``IPCSearchParams` (extends `URLSearchParams`)` in `api/ipc.js`, it's exported but undocumented.


## [`emit(name, value, target, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/ipc.js#L1218)
...
## [`send(command, value, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/ipc.js#L1277)
...
## [`inflateIPCMessageTransfers()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/ipc.js#L1728)

This is a `FunctionDeclaration` named `inflateIPCMessageTransfers` in `api/ipc.js`, it's exported but undocumented.


## [`findIPCMessageTransfers()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/ipc.js#L1760)

This is a `FunctionDeclaration` named `findIPCMessageTransfers` in `api/ipc.js`, it's exported but undocumented.


## [ports](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/ipc.js#L1825)

This is a `VariableDeclaration` named `ports` in `api/ipc.js`, it's exported but undocumented.


## [`IPCMessagePort` (extends `MessagePort`)](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/ipc.js#L1827)

This is a `ClassDeclaration` named ``IPCMessagePort` (extends `MessagePort`)` in `api/ipc.js`, it's exported but undocumented.


## [`IPCMessageChannel` (extends `MessageChannel`)](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/ipc.js#L2053)
...
# [network](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/network.js#L9)
...
# [os](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/os.js#L13)
...
## [`arch()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/os.js#L60)
...
## [`cpus()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/os.js#L78)
...
## [`networkInterfaces()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/os.js#L102)
...
## [`platform()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/os.js#L190)
...
## [`type()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/os.js#L199)
...
## [`isWindows()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/os.js#L238)
...
## [`tmpdir()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/os.js#L250)
...
## [EOL](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/os.js#L298)

 The operating system's end-of-line marker. `'\r\n'` on Windows and `'\n'` on POSIX.

## [`rusage()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/os.js#L310)

Get resource usage.

## [`uptime()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/os.js#L320)
...
## [`uname()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/os.js#L331)
...
## [`homedir()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/os.js#L389)
...
# [path](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L9)
...
## [`resolve()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L44)
...
## [`cwd(opts)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L82)
...
## [`origin()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L106)
...
## [`relative(options, from, to)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L117)
...
## [`join(options, components)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L164)
...
## [`dirname(options, components)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L221)
...
## [`basename(options, components)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L263)
...
## [`extname(options, path)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L277)
...
## [`normalize(options, path)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L288)
...
## [`format(options, path)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L338)
...
## [`parse(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L354)
...
## [Path](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L382)

A container for a parsed Path.

### [`from(input, cwd)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L388)
...
### [`constructor(pathname, cwd)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L411)
...
### [`isRelative()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L484)

`true` if the path is relative, otherwise `false.

### [`value()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L491)

The working value of this path.

### [`source()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L525)

The original source, unresolved.

### [`parent()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L533)

Computed parent path.

### [`root()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L552)

Computed root in path.

### [`dir()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L573)

Computed directory name in path.

### [`base()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L608)

Computed base name in path.

### [`name()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L620)

Computed base name in path without path extension.

### [`ext()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L628)

Computed extension name in path.

### [`drive()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L648)

The computed drive, if given in the path.

### [`toURL()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L655)
...
### [`toString()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/path/path.js#L663)
...
# [process](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/process.js#L9)
...
## [`ProcessEnvironmentEvent` (extends `Event`)](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/process.js#L18)

This is a `ClassDeclaration` named ``ProcessEnvironmentEvent` (extends `Event`)` in `api/process.js`, it's exported but undocumented.


## [`ProcessEnvironment` (extends `EventTarget`)](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/process.js#L29)

This is a `ClassDeclaration` named ``ProcessEnvironment` (extends `EventTarget`)` in `api/process.js`, it's exported but undocumented.


## [env](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/process.js#L35)

This is a `VariableDeclaration` named `env` in `api/process.js`, it's exported but undocumented.


## [`nextTick(callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/process.js#L202)
...
## [`hrtime(time)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/process.js#L235)
...
## [`exit(code)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/process.js#L261)
...
## [`memoryUsage()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/process.js#L273)
...
# [test](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L17)
...
## [`getDefaultTestRunnerTimeout()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L54)
...
## [Test](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L69)



### [`constructor(name, fn, runner)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L127)
...
### [`comment(msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L138)
...
### [`plan(n)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L148)
...
### [`deepEqual(actual, expected, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L159)
...
### [`notDeepEqual(actual, expected, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L174)
...
### [`equal(actual, expected, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L189)
...
### [`notEqual(actual, expected, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L204)
...
### [`fail(msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L217)
...
### [`ok(actual, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L230)
...
### [`pass(msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L242)
...
### [`ifError(err, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L251)
...
### [`throws(fn, expected, message)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L264)
...
### [`sleep(ms, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L313)
...
### [`requestAnimationFrame(msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L331)
...
### [`click(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L354)
...
### [`eventClick(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L380)
...
### [`dispatchEvent(event, target, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L408)
...
### [`focus(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L428)
...
### [`blur(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L452)
...
### [`type(selector, str, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L477)
...
### [`appendChild(parentSelector, el, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L509)
...
### [`removeElement(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L529)
...
### [`elementVisible(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L548)
...
### [`elementInvisible(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L569)
...
### [`waitFor(querySelectorOrFn, opts, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L593)
...
### [`waitForText(selector, opts, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L655)
...
### [`querySelector(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L692)
...
### [`querySelectorAll(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L711)
...
### [`getComputedStyle(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L740)
...
### [`run()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L837)

   pass: number,
   fail: number
 }>}

## [TestRunner](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L918)



### [`constructor(report)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L969)
...
### [`nextId()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L978)
...
### [`length()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L985)



### [`add(name, fn, only)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L995)
...
### [`run()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L1017)
...
### [`onFinish())`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L1064)
...
## [`only(name, fn)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L1092)
...
## [`skip(_name, _fn)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L1102)
...
## [`setStrict(strict)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/test/index.js#L1108)
...
# [window](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L12)
...
## [ApplicationWindow](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L35)

 Represents a window in the application

### [`id()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L69)

The unique ID of this window.

### [`index()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L77)
...
### [`hotkey()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L84)



### [`channel()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L92)

The broadcast channel for this window.

### [`getSize()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L100)
...
### [`getPosition()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L111)
...
### [`getTitle()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L122)
...
### [`getStatus()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L130)
...
### [`close()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L138)
...
### [`show()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L153)
...
### [`hide()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L162)
...
### [`maximize()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L171)
...
### [`minimize()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L180)
...
### [`restore()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L189)
...
### [`setTitle(title)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L199)
...
### [`setSize(opts)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L212)
...
### [`setPosition(opts)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L255)
...
### [`navigate(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L299)
...
### [`showInspector()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L308)
...
### [`setBackgroundColor(opts)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L325)
...
### [`getBackgroundColor()`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L334)
...
### [`setContextMenu(options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L343)
...
### [`showOpenFilePicker(options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L352)
...
### [`showSaveFilePicker(options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L370)
...
### [`showDirectoryFilePicker(options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L388)
...
### [`send(options)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L413)
...
### [`postMessage(message)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L454)
...
### [`openExternal(value)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L473)
...
### [`revealFile(value)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L488)
...
### [`addListener(event, cb)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L503)
...
### [`on(event, cb)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L521)
...
### [`once(event, cb)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L538)
...
### [`removeListener(event, cb)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L554)
...
### [`removeAllListeners(event)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L567)
...
### [`off(event, cb)`](https://github.com/socketsupply/socket/blob/v0.6.0-rc.5/api/window.js#L583)
