...
# [Test.DOM-helpers](https://github.com/socketsupply/socket/blob/master/api/test/dom-helpers.js#L16)
...
## [`toElement(selector)`](https://github.com/socketsupply/socket/blob/master/api/test/dom-helpers.js#L28)
...
| Argument | Type | Default | Optional | Description |
| :---     | :--- | :---:   | :---:    | :---        |
| selector | string \| Element |  | false | A CSS selector string, or an instance of HTMLElement, or Element. |

| Return Value | Type | Description |
| :---         | :--- | :---        |
| Not specified | Element | The HTMLElement, Element, or Window that corresponds to the selector. |

## [`waitFor(args, lambda)`](https://github.com/socketsupply/socket/blob/master/api/test/dom-helpers.js#L58)
...
| Argument | Type | Default | Optional | Description |
| :---     | :--- | :---:   | :---:    | :---        |
| args | Object |  | false | Configuration arguments. |
| args.selector | string |  | false | The CSS selector to look for. |
| args.visible | boolean | true | false | Whether the element should be visible. |
| args.timeout | number | defaultTimeout | false | Time in milliseconds to wait before rejecting the promise. |
| lambda | () => HTMLElement \| Element \| null \| undefined |  | false | An optional function that returns the element. Used if the `selector` is not provided. |

| Return Value | Type | Description |
| :---         | :--- | :---        |
| Not specified | Promise<Element \| HTMLElement \| void> | A promise that resolves to the found element. |

## [`waitForText(args)`](https://github.com/socketsupply/socket/blob/master/api/test/dom-helpers.js#L110)
...
| :---     | :--- | :---:   | :---:    | :---        |
| args | Object |  | false | Configuration arguments. |
| args.element | Element |  | false | The root element from which to begin searching. |
| args.text | string |  | false | The text to search for within elements. |
| args.regex | RegExp |  | false | A regular expression to match against element text content. |
| args.multipleTags | boolean | false | false | Whether to look for text across multiple sibling elements. |
| args.timeout | number | defaultTimeout | false | Time in milliseconds to wait before rejecting the promise. |

| Return Value | Type | Description |
| :---         | :--- | :---        |
| Not specified | Promise<Element \| HTMLElement \| void> | A promise that resolves to the found element or null. |

## [`event(args)`](https://github.com/socketsupply/socket/blob/master/api/test/dom-helpers.js#L185)



| Argument | Type | Default | Optional | Description |
| :---     | :--- | :---:   | :---:    | :---        |
| args | Object |  | false | Arguments |
| args.event | string \| Event |  | false | The event to dispatch. |
| args.element | HTMLElement \| Element \| window | window | false | The element to dispatch the event on. |

## [`isElementVisible(element, previousElement)`](https://github.com/socketsupply/socket/blob/master/api/test/dom-helpers.js#L209)

 Copy pasted from https://raw.githubusercontent.com/testing-library/jest-dom/master/src/to-be-visible.js

| Argument | Type | Default | Optional | Description |
| :---     | :--- | :---:   | :---:    | :---        |
| element | Element \| HTMLElement |  | false |  |
| previousElement | Element \| HTMLElement |  | false |  |
