...
# [Application](https://github.com/socketsupply/socket/blob/v0.3.3/api/application.js#L13)
...
## [`createWindow(opts)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/application.js#L40)
...
## [`getScreenSize()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/application.js#L98)
...
## [`getWindows(indices)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/application.js#L118)
...
## [`getWindow(index)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/application.js#L137)
...
## [`getCurrentWindow()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/application.js#L147)
...
## [`exit(code)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/application.js#L156)
...
## [`setSystemMenu(options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/application.js#L253)
...
## [`setSystemMenuItemEnabled(value)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/application.js#L307)
...
## [runtimeVersion](https://github.com/socketsupply/socket/blob/v0.3.3/api/application.js#L315)

Socket Runtime version.

## [debug](https://github.com/socketsupply/socket/blob/v0.3.3/api/application.js#L321)

Runtime debug flag.

## [config](https://github.com/socketsupply/socket/blob/v0.3.3/api/application.js#L327)

Application configuration.

## [backend](https://github.com/socketsupply/socket/blob/v0.3.3/api/application.js#L332)

The application's backend instance.

### [`open(opts)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/application.js#L338)
...
### [`close()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/application.js#L346)
...
# [Bluetooth](https://github.com/socketsupply/socket/blob/v0.3.3/api/bluetooth.js#L12)
...
## [`Bluetooth` (extends `EventEmitter`)](https://github.com/socketsupply/socket/blob/v0.3.3/api/bluetooth.js#L32)

Create an instance of a Bluetooth service.

### [`constructor(serviceId)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/bluetooth.js#L40)
...
### [`start()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/bluetooth.js#L90)
...
### [`subscribe(id )`](https://github.com/socketsupply/socket/blob/v0.3.3/api/bluetooth.js#L119)
...
### [`publish(id, value)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/bluetooth.js#L142)
...
# [Crypto](https://github.com/socketsupply/socket/blob/v0.3.3/api/crypto.js#L14)
...
## [webcrypto](https://github.com/socketsupply/socket/blob/v0.3.3/api/crypto.js#L23)

WebCrypto API

## [ready](https://github.com/socketsupply/socket/blob/v0.3.3/api/crypto.js#L52)

A promise that resolves when all internals to be loaded/ready.

## [`getRandomValues(buffer)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/crypto.js#L67)
...
## [`rand64()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/crypto.js#L86)

This is a `FunctionDeclaration` named `rand64` in `api/crypto.js`, it's exported but undocumented.


## [RANDOM_BYTES_QUOTA](https://github.com/socketsupply/socket/blob/v0.3.3/api/crypto.js#L94)

Maximum total size of random bytes per page

## [MAX_RANDOM_BYTES](https://github.com/socketsupply/socket/blob/v0.3.3/api/crypto.js#L99)

Maximum total size for random bytes.

## [MAX_RANDOM_BYTES_PAGES](https://github.com/socketsupply/socket/blob/v0.3.3/api/crypto.js#L104)

Maximum total amount of allocated per page of bytes (max/quota)

## [`randomBytes(size)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/crypto.js#L112)
...
## [`createDigest(algorithm, message)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/crypto.js#L139)
...
# [Dgram](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L13)
...
## [`createSocket(options, callback)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L623)
...
## [`Socket` (extends `EventEmitter`)](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L629)

New instances of dgram.Socket are created using dgram.createSocket().
 The new keyword is not to be used to create dgram.Socket instances.

### [`bind(port, address, callback)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L704)
...
### [`connect(port, host, connectListener)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L757)
...
### [`disconnect()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L792)
...
### [`send(msg, offset, length, port, address, callback)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L851)
...
### [`close(callback)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L931)
...
### [`address()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L997)
...
### [`remoteAddress()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L1032)
...
### [`setRecvBufferSize(size)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L1063)
...
### [`setSendBufferSize(size)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L1080)
...
### [`getRecvBufferSize()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L1093)

External docs: https://nodejs.org/api/dgram.html#socketgetrecvbuffersize



### [`getSendBufferSize()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L1101)
...
## [`ERR_SOCKET_ALREADY_BOUND` (extends `SocketError`)](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L1172)

Thrown when a socket is already bound.

## [`ERR_SOCKET_DGRAM_IS_CONNECTED` (extends `SocketError`)](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L1189)

Thrown when the socket is already connected.

## [`ERR_SOCKET_DGRAM_NOT_CONNECTED` (extends `SocketError`)](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L1196)

Thrown when the socket is not connected.

## [`ERR_SOCKET_DGRAM_NOT_RUNNING` (extends `SocketError`)](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L1204)

Thrown when the socket is not running (not bound or connected).

## [`ERR_SOCKET_BAD_TYPE` (extends `TypeError`)](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L1211)

Thrown when a bad socket type is used in an argument.

## [`ERR_SOCKET_BAD_PORT` (extends `RangeError`)](https://github.com/socketsupply/socket/blob/v0.3.3/api/dgram.js#L1221)

Thrown when a bad port is given.

# [DNS](https://github.com/socketsupply/socket/blob/v0.3.3/api/dns/index.js#L17)
...
## [`lookup(hostname, opts, cb)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/dns/index.js#L60)
...
# [DNS.promises](https://github.com/socketsupply/socket/blob/v0.3.3/api/dns/promises.js#L17)
...
## [`lookup(hostname, opts)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/dns/promises.js#L37)
...
## [Event](https://github.com/socketsupply/socket/blob/v0.3.3/api/events.js#L472)

This is a `VariableDeclaration` named `Event` in `api/events.js`, it's exported but undocumented.


## [CustomEvent](https://github.com/socketsupply/socket/blob/v0.3.3/api/events.js#L474)

This is a `VariableDeclaration` named `CustomEvent` in `api/events.js`, it's exported but undocumented.


## [MessageEvent](https://github.com/socketsupply/socket/blob/v0.3.3/api/events.js#L489)

This is a `VariableDeclaration` named `MessageEvent` in `api/events.js`, it's exported but undocumented.


## [ErrorEvent](https://github.com/socketsupply/socket/blob/v0.3.3/api/events.js#L513)

This is a `VariableDeclaration` named `ErrorEvent` in `api/events.js`, it's exported but undocumented.


# [File System](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/index.js#L26)
...
## [`access(path, mode , callback)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/index.js#L81)
...
## [`chmod(path, mode, callback)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/index.js#L114)
...
## [`close(fd, callback)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/index.js#L144)
...
## [`copyFile()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/index.js#L160)

This is a `FunctionDeclaration` named `copyFile` in `api/fs/index.js`, it's exported but undocumented.


## [`createReadStream(path, options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/index.js#L169)
...
## [`createWriteStream(path, options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/index.js#L209)
...
## [`fstat(fd, options, callback)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/index.js#L253)
...
## [`open(path, flags , mode , callback)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/index.js#L336)
...
## [`opendir(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/index.js#L389)
...
## [`read(fd, buffer, offset, length, position, callback)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/index.js#L415)
...
## [`readdir(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/index.js#L449)
...
## [`readFile(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/index.js#L500)
...
## [`stat(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/index.js#L573)
...
## [`writeFile(path, data, options, callback)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/index.js#L643)
...
## [`writev()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/index.js#L680)

This is a `FunctionDeclaration` named `writev` in `api/fs/index.js`, it's exported but undocumented.


# [FS.promises](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/promises.js#L25)
...
## [`access(path, mode, options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/promises.js#L62)
...
## [`chmod(path, mode)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/promises.js#L79)
...
## [`mkdir(path, options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/promises.js#L148)
...
## [`open(path, flags, mode)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/promises.js#L172)
...
## [`opendir(path, options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/promises.js#L184)
...
## [`readdir(path, options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/promises.js#L196)
...
## [`readFile(path, options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/promises.js#L229)
...
## [`stat(path, options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/promises.js#L284)
...
## [`writeFile(path, data, options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/fs/promises.js#L337)
...
# [IPC](https://github.com/socketsupply/socket/blob/v0.3.3/api/ipc.js#L33)
...
## [`emit(name, value, target , options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/ipc.js#L1031)
...
## [`send(command, value, options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/ipc.js#L1090)
...
# [OS](https://github.com/socketsupply/socket/blob/v0.3.3/api/os.js#L13)
...
## [`Peer` (extends `EventEmitter`)](https://github.com/socketsupply/socket/blob/v0.3.3/api/peer.js#L52)
...
### [`constructor(options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/peer.js#L62)
...
### [`createKeys()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/peer.js#L82)
...
### [`createClusterId()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/peer.js#L96)
...
### [`emit(event, message)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/peer.js#L107)
...
### [`join()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/peer.js#L130)
...
# [Path](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L9)
...
## [`Path` (extends `URL`)](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L32)

A container for a parsed Path.

### [`cwd(opts)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L39)
...
### [`resolve(options, components)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L58)
...
### [`relative(options, from, to)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L86)
...
### [`join(options, components)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L133)
...
### [`dirname(options, components)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L163)
...
### [`basename(options, components)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L235)
...
### [`extname(options, path)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L250)
...
### [`normalize(options, path)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L261)
...
### [`format(options, path)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L311)
...
### [`parse(path)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L327)
...
### [`from(input, cwd)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L353)
...
### [`constructor(pathname, cwd )`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L374)
...
### [`isRelative()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L407)

`true` if the path is relative, otherwise `false.

### [`value()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L414)

The working value of this path.

### [`source()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L425)

The original source, unresolved.

### [`parent()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L433)

Computed parent path.

### [`root()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L451)

Computed root in path.

### [`dir()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L472)

Computed directory name in path.

### [`base()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L507)

Computed base name in path.

### [`name()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L519)

Computed base name in path without path extension.

### [`ext()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L527)

Computed extension name in path.

### [`drive()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L545)

The computed drive, if given in the path.

### [`toURL()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L552)
...
### [`toString()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/path/path.js#L560)
...
# [Process](https://github.com/socketsupply/socket/blob/v0.3.3/api/process.js#L9)
...
## [`nextTick()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/process.js#L38)

This is a `FunctionDeclaration` named `nextTick` in `api/process.js`, it's exported but undocumented.


## [`homedir()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/process.js#L67)
...
## [`hrtime(time)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/process.js#L76)
...
## [`exit(code)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/process.js#L100)
...
## [`memoryUsage()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/process.js#L108)

This is a `FunctionDeclaration` named `memoryUsage` in `api/process.js`, it's exported but undocumented.


# [Window](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L11)
...
## [ApplicationWindow](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L28)

 Represents a window in the application

### [`index()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L56)
...
### [`getSize()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L64)
...
### [`getTitle()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L75)
...
### [`getStatus()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L83)
...
### [`close()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L91)
...
### [`show()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L106)
...
### [`hide()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L115)
...
### [`setTitle(title)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L125)
...
### [`setSize(opts)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L138)
...
### [`navigate(path)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L178)
...
### [`showInspector()`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L187)
...
### [`setBackgroundColor(opts)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L204)
...
### [`setContextMenu(options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L214)
...
### [`showOpenFilePicker(options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L231)
...
### [`showSaveFilePicker(options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L242)
...
### [`showDirectoryFilePicker(options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L253)
...
### [`send(options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L268)
...
### [`openExternal(options)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L305)
...
### [`addListener(event, cb)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L316)
...
### [`on(event, cb)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L334)
...
### [`once(event, cb)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L351)
...
### [`removeListener(event, cb)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L367)
...
### [`removeAllListeners(event)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L380)
...
### [`off(event, cb)`](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L396)
...
## [constants](https://github.com/socketsupply/socket/blob/v0.3.3/api/window.js#L406)
