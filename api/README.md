...
# [Bluetooth](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/bluetooth.js#L12)
...
## [`Bluetooth` (extends `EventEmitter`)](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/bluetooth.js#L32)

Create an instance of a Bluetooth service.

### [`constructor(serviceId)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/bluetooth.js#L40)
...
### [`start()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/bluetooth.js#L90)
...
### [`subscribe(id)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/bluetooth.js#L119)
...
### [`publish(id, value)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/bluetooth.js#L142)
...
# [Crypto](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/crypto.js#L15)
...
## [webcrypto](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/crypto.js#L30)

External docs: https://developer.mozilla.org/en-US/docs/Web/API/Crypto
WebCrypto API

## [ready](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/crypto.js#L59)

A promise that resolves when all internals to be loaded/ready.

## [`getRandomValues(buffer)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/crypto.js#L74)
...
## [`rand64()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/crypto.js#L97)
...
## [RANDOM_BYTES_QUOTA](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/crypto.js#L105)

Maximum total size of random bytes per page

## [MAX_RANDOM_BYTES](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/crypto.js#L110)

Maximum total size for random bytes.

## [MAX_RANDOM_BYTES_PAGES](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/crypto.js#L115)

Maximum total amount of allocated per page of bytes (max/quota)

## [`randomBytes(size)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/crypto.js#L123)
...
## [`createDigest(algorithm, message)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/crypto.js#L150)
...
## [`murmur3(value, seed)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/crypto.js#L161)
...
# [DNS](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dns/index.js#L17)
...
## [`lookup(hostname, options, cb)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dns/index.js#L60)
...
# [DNS.promises](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dns/promises.js#L17)
...
## [`lookup(hostname, opts)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dns/promises.js#L37)
...
# [Dgram](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L13)
...
## [`createSocket(options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L651)
...
## [`Socket` (extends `EventEmitter`)](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L657)

New instances of dgram.Socket are created using dgram.createSocket().
 The new keyword is not to be used to create dgram.Socket instances.

### [`bind(port, address, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L738)
...
### [`connect(port, host, connectListener)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L853)
...
### [`disconnect()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L890)
...
### [`send(msg, offset, length, port, address, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L949)
...
### [`close(callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L1036)
...
### [`remoteAddress()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L1143)
...
### [`setRecvBufferSize(size)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L1174)
...
### [`setSendBufferSize(size)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L1191)
...
### [`getRecvBufferSize()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L1204)

External docs: https://nodejs.org/api/dgram.html#socketgetrecvbuffersize


### [`getSendBufferSize()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L1212)
...
## [`ERR_SOCKET_ALREADY_BOUND` (extends `SocketError`)](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L1286)

Thrown when a socket is already bound.

## [`ERR_SOCKET_DGRAM_IS_CONNECTED` (extends `SocketError`)](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L1303)

Thrown when the socket is already connected.

## [`ERR_SOCKET_DGRAM_NOT_CONNECTED` (extends `SocketError`)](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L1310)

Thrown when the socket is not connected.

## [`ERR_SOCKET_DGRAM_NOT_RUNNING` (extends `SocketError`)](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L1318)

Thrown when the socket is not running (not bound or connected).

## [`ERR_SOCKET_BAD_TYPE` (extends `TypeError`)](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L1325)

Thrown when a bad socket type is used in an argument.

## [`ERR_SOCKET_BAD_PORT` (extends `RangeError`)](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/dgram.js#L1335)
...
# [FS](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L26)
...
## [`access(path, mode, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L109)
...
## [`accessSync(path, mode)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L134)
...
## [`exists(path, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L151)
...
## [`existsSync(path, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L168)
...
## [`chmod(path, mode, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L188)
...
## [`chmodSync(path, mode)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L214)
...
## [`chown(path, uid, gid, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L238)
...
## [`close(fd, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L294)
...
## [`closeSync(fd)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L314)
...
## [`copyFile(src, dest, flags, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L331)
...
## [`copyFileSync(src, dest, flags)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L363)
...
## [`createReadStream(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L392)
...
## [`createWriteStream(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L437)
...
## [`fstat(fd, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L485)
...
## [`fsync(fd, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L512)
...
## [`ftruncate(fd, offset, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L534)
...
## [`lchown(path, uid, gid, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L562)
...
## [`link(src, dest, )`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L592)
...
## [`open(path, flags, mode, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L680)
...
## [`openSync(path, flags, mode, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L733)
...
## [`opendir(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L780)
...
## [`opendirSync(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L807)
...
## [`read(fd, buffer, offset, length, position, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L834)
...
## [`write(fd, buffer, offset, length, position, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L869)
...
## [`readdir(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L903)
...
## [`readdirSync(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L955)
...
## [`readFile(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L985)
...
## [`readFileSync(path, } options, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L1027)
...
## [`readlink(path, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L1090)
...
## [`realpath(path, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L1110)
...
## [`realpathSync(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L1128)
...
## [`renameSync(src, dest)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L1172)
...
## [`rmdir(path, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L1196)
...
## [`rmdirSync(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L1216)
...
## [`statSync(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L1237)
...
## [`stat(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L1257)
...
## [`lstat(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L1295)
...
## [`symlink(src, dest)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L1329)
...
## [`unlink(path, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L1372)
...
## [`unlinkSync(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L1392)
...
## [`writeFile(path, data, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L1417)
...
## [`writeFileSync(path, data, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L1462)
...
## [`watch(, options, callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/index.js#L1497)
...
# [FS.promises](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L25)
...
## [`access(path, mode, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L107)
...
## [`chmod(path, mode)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L118)
...
## [`chown(path, uid, gid)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L143)
...
## [`copyFile(src, dest, flags)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L172)
...
## [`lchown(path, uid, gid)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L202)
...
## [`link(src, dest)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L230)
...
## [`mkdir(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L258)
...
## [`open(path, flags, mode)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L288)
...
## [`opendir(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L301)
...
## [`readdir(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L314)
...
## [`readFile(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L352)
...
## [`readlink(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L370)
...
## [`realpath(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L391)
...
## [`rename(src, dest)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L413)
...
## [`rmdir(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L437)
...
## [`stat(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L459)
...
## [`lstat(path, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L474)
...
## [`symlink(src, dest)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L487)
...
## [`unlink(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L523)
...
## [`writeFile(path, data, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L548)
...
## [`watch(, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/fs/promises.js#L569)
...
# [IPC](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/ipc.js#L37)
...
## [`IPCSearchParams` (extends `URLSearchParams`)](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/ipc.js#L1022)

This is a `ClassDeclaration` named ``IPCSearchParams` (extends `URLSearchParams`)` in `api/ipc.js`, it's exported but undocumented.


## [`emit(name, value, target, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/ipc.js#L1183)
...
## [`send(command, value, options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/ipc.js#L1242)
...
## [`inflateIPCMessageTransfers()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/ipc.js#L1693)

This is a `FunctionDeclaration` named `inflateIPCMessageTransfers` in `api/ipc.js`, it's exported but undocumented.


## [`findIPCMessageTransfers()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/ipc.js#L1725)

This is a `FunctionDeclaration` named `findIPCMessageTransfers` in `api/ipc.js`, it's exported but undocumented.


## [ports](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/ipc.js#L1774)

This is a `VariableDeclaration` named `ports` in `api/ipc.js`, it's exported but undocumented.


## [`IPCMessagePort` (extends `MessagePort`)](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/ipc.js#L1776)

This is a `ClassDeclaration` named ``IPCMessagePort` (extends `MessagePort`)` in `api/ipc.js`, it's exported but undocumented.


## [`IPCMessageChannel` (extends `MessageChannel`)](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/ipc.js#L1981)
...
# [Network](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/network.js#L9)
...
# [OS](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/os.js#L13)
...
## [`arch()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/os.js#L60)
...
## [`cpus()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/os.js#L78)
...
## [`networkInterfaces()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/os.js#L102)
...
## [`platform()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/os.js#L190)
...
## [`type()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/os.js#L199)
...
## [`isWindows()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/os.js#L238)
...
## [`tmpdir()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/os.js#L250)
...
## [EOL](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/os.js#L298)

 The operating system's end-of-line marker. `'\r\n'` on Windows and `'\n'` on POSIX.

## [`rusage()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/os.js#L310)

Get resource usage.

## [`uptime()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/os.js#L320)
...
## [`uname()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/os.js#L331)
...
## [`homedir()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/os.js#L389)
...
# [Path](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L9)
...
## [`resolve()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L44)
...
## [`cwd(opts)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L82)
...
## [`origin()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L106)
...
## [`relative(options, from, to)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L117)
...
## [`join(options, components)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L164)
...
## [`dirname(options, components)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L221)
...
## [`basename(options, components)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L263)
...
## [`extname(options, path)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L277)
...
## [`normalize(options, path)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L288)
...
## [`format(options, path)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L338)
...
## [`parse(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L354)
...
## [Path](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L382)

A container for a parsed Path.

### [`from(input, cwd)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L388)
...
### [`constructor(pathname, cwd)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L411)
...
### [`isRelative()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L484)

`true` if the path is relative, otherwise `false.

### [`value()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L491)

The working value of this path.

### [`source()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L525)

The original source, unresolved.

### [`parent()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L533)

Computed parent path.

### [`root()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L552)

Computed root in path.

### [`dir()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L573)

Computed directory name in path.

### [`base()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L608)

Computed base name in path.

### [`name()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L620)

Computed base name in path without path extension.

### [`ext()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L628)

Computed extension name in path.

### [`drive()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L648)

The computed drive, if given in the path.

### [`toURL()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L655)
...
### [`toString()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/path/path.js#L663)
...
# [Process](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/process.js#L9)
...
## [`ProcessEnvironmentEvent` (extends `Event`)](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/process.js#L18)

This is a `ClassDeclaration` named ``ProcessEnvironmentEvent` (extends `Event`)` in `api/process.js`, it's exported but undocumented.


## [`ProcessEnvironment` (extends `EventTarget`)](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/process.js#L29)

This is a `ClassDeclaration` named ``ProcessEnvironment` (extends `EventTarget`)` in `api/process.js`, it's exported but undocumented.


## [env](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/process.js#L34)

This is a `VariableDeclaration` named `env` in `api/process.js`, it's exported but undocumented.


## [`nextTick(callback)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/process.js#L197)
...
## [`hrtime(time)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/process.js#L230)
...
## [`exit(code)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/process.js#L256)
...
## [`memoryUsage()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/process.js#L268)
...
# [Test](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L17)
...
## [`getDefaultTestRunnerTimeout()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L54)
...
## [Test](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L69)



### [`constructor(name, fn, runner)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L127)
...
### [`comment(msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L138)
...
### [`deepEqual(actual, expected, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L159)
...
### [`notDeepEqual(actual, expected, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L174)
...
### [`equal(actual, expected, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L189)
...
### [`notEqual(actual, expected, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L204)
...
### [`fail(msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L217)
...
### [`ok(actual, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L230)
...
### [`pass(msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L242)
...
### [`throws(fn, expected, message)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L264)
...
### [`sleep(ms, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L313)
...
### [`requestAnimationFrame(msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L331)
...
### [`click(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L354)
...
### [`eventClick(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L380)
...
### [`dispatchEvent(event, target, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L408)
...
### [`focus(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L428)
...
### [`blur(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L452)
...
### [`type(selector, str, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L477)
...
### [`appendChild(parentSelector, el, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L509)
...
### [`removeElement(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L529)
...
### [`elementVisible(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L548)
...
### [`elementInvisible(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L569)
...
### [`waitFor(querySelectorOrFn, opts, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L593)
...
### [`waitForText(selector, opts, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L655)
...
### [`querySelector(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L692)
...
### [`querySelectorAll(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L711)
...
### [`getComputedStyle(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L740)
...
### [`run()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L837)

   pass: number,
   fail: number
 }>}

## [TestRunner](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L918)



### [`constructor(report)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L969)
...
### [`nextId()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L978)
...
### [`length()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L985)



### [`add(name, fn, only)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L995)
...
### [`run()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L1017)
...
### [`onFinish())`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L1064)
...
## [`only(name, fn)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L1092)
...
## [`skip(_name, _fn)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L1102)
...
## [`setStrict(strict)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/test/index.js#L1108)
...
# [Window](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L12)
...
## [ApplicationWindow](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L35)

 Represents a window in the application

### [`id()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L69)

The unique ID of this window.

### [`index()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L77)
...
### [`hotkey()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L84)



### [`channel()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L92)

The broadcast channel for this window.

### [`getSize()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L100)
...
### [`getPosition()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L111)
...
### [`getTitle()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L122)
...
### [`getStatus()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L130)
...
### [`close()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L138)
...
### [`show()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L153)
...
### [`hide()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L162)
...
### [`maximize()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L171)
...
### [`minimize()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L180)
...
### [`restore()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L189)
...
### [`setTitle(title)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L199)
...
### [`setSize(opts)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L212)
...
### [`setPosition(opts)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L255)
...
### [`navigate(path)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L299)
...
### [`showInspector()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L308)
...
### [`setBackgroundColor(opts)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L325)
...
### [`getBackgroundColor()`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L334)
...
### [`setContextMenu(options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L343)
...
### [`showOpenFilePicker(options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L352)
...
### [`showSaveFilePicker(options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L370)
...
### [`showDirectoryFilePicker(options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L388)
...
### [`send(options)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L413)
...
### [`openExternal(value)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L473)
...
### [`revealFile(value)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L488)
...
### [`addListener(event, cb)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L503)
...
### [`on(event, cb)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L521)
...
### [`once(event, cb)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L538)
...
### [`removeListener(event, cb)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L554)
...
### [`removeAllListeners(event)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L567)
...
### [`off(event, cb)`](https://github.com/socketsupply/socket/blob/v0.6.0-next/api/window.js#L583)
