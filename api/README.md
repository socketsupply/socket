...
# [Application](https://github.com/socketsupply/socket/blob/v0.5.1/api/application.js#L13)
...
## [`createWindow(opts)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/application.js#L38)
...
## [`getScreenSize()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/application.js#L96)
...
## [`getWindows(indices)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/application.js#L122)
...
## [`getWindow(index)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/application.js#L152)
...
## [`getCurrentWindow()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/application.js#L162)
...
## [`exit(code)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/application.js#L171)
...
## [`setSystemMenu(options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/application.js#L268)
...
## [`setSystemMenuItemEnabled(value)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/application.js#L350)
...
## [runtimeVersion](https://github.com/socketsupply/socket/blob/v0.5.1/api/application.js#L358)

Socket Runtime version.

## [debug](https://github.com/socketsupply/socket/blob/v0.5.1/api/application.js#L364)

Runtime debug flag.

## [config](https://github.com/socketsupply/socket/blob/v0.5.1/api/application.js#L370)

Application configuration.

## [backend](https://github.com/socketsupply/socket/blob/v0.5.1/api/application.js#L375)

The application's backend instance.

### [`open(opts)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/application.js#L381)
...
### [`close()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/application.js#L389)
...
# [Bluetooth](https://github.com/socketsupply/socket/blob/v0.5.1/api/bluetooth.js#L12)
...
## [`Bluetooth` (extends `EventEmitter`)](https://github.com/socketsupply/socket/blob/v0.5.1/api/bluetooth.js#L32)

Create an instance of a Bluetooth service.

### [`constructor(serviceId)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/bluetooth.js#L40)
...
### [`start()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/bluetooth.js#L90)
...
### [`subscribe(id)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/bluetooth.js#L119)
...
### [`publish(id, value)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/bluetooth.js#L142)
...
# [Crypto](https://github.com/socketsupply/socket/blob/v0.5.1/api/crypto.js#L15)
...
## [webcrypto](https://github.com/socketsupply/socket/blob/v0.5.1/api/crypto.js#L30)

External docs: https://developer.mozilla.org/en-US/docs/Web/API/Crypto
WebCrypto API

## [ready](https://github.com/socketsupply/socket/blob/v0.5.1/api/crypto.js#L59)

A promise that resolves when all internals to be loaded/ready.

## [`getRandomValues(buffer)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/crypto.js#L74)
...
## [`rand64()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/crypto.js#L97)
...
## [RANDOM_BYTES_QUOTA](https://github.com/socketsupply/socket/blob/v0.5.1/api/crypto.js#L105)

Maximum total size of random bytes per page

## [MAX_RANDOM_BYTES](https://github.com/socketsupply/socket/blob/v0.5.1/api/crypto.js#L110)

Maximum total size for random bytes.

## [MAX_RANDOM_BYTES_PAGES](https://github.com/socketsupply/socket/blob/v0.5.1/api/crypto.js#L115)

Maximum total amount of allocated per page of bytes (max/quota)

## [`randomBytes(size)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/crypto.js#L123)
...
## [`createDigest(algorithm, message)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/crypto.js#L150)
...
## [`murmur3(value, seed)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/crypto.js#L161)
...
# [DNS](https://github.com/socketsupply/socket/blob/v0.5.1/api/dns/index.js#L17)
...
## [`lookup(hostname, options, cb)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/dns/index.js#L60)
...
# [DNS.promises](https://github.com/socketsupply/socket/blob/v0.5.1/api/dns/promises.js#L17)
...
## [`lookup(hostname, opts)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/dns/promises.js#L37)
...
# [Dgram](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L13)
...
## [`createSocket(options, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L623)
...
## [`Socket` (extends `EventEmitter`)](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L629)

New instances of dgram.Socket are created using dgram.createSocket().
 The new keyword is not to be used to create dgram.Socket instances.

### [`bind(port, address, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L705)
...
### [`connect(port, host, connectListener)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L781)
...
### [`disconnect()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L816)
...
### [`send(msg, offset, length, port, address, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L875)
...
### [`close(callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L955)
...
### [`address()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L1021)
...
### [`remoteAddress()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L1056)
...
### [`setRecvBufferSize(size)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L1087)
...
### [`setSendBufferSize(size)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L1104)
...
### [`getRecvBufferSize()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L1117)

External docs: https://nodejs.org/api/dgram.html#socketgetrecvbuffersize


### [`getSendBufferSize()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L1125)
...
### [`code()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L1193)



## [`ERR_SOCKET_ALREADY_BOUND` (extends `SocketError`)](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L1199)

Thrown when a socket is already bound.

## [`ERR_SOCKET_DGRAM_IS_CONNECTED` (extends `SocketError`)](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L1216)

Thrown when the socket is already connected.

## [`ERR_SOCKET_DGRAM_NOT_CONNECTED` (extends `SocketError`)](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L1223)

Thrown when the socket is not connected.

## [`ERR_SOCKET_DGRAM_NOT_RUNNING` (extends `SocketError`)](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L1231)

Thrown when the socket is not running (not bound or connected).

## [`ERR_SOCKET_BAD_TYPE` (extends `TypeError`)](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L1238)

Thrown when a bad socket type is used in an argument.

## [`ERR_SOCKET_BAD_PORT` (extends `RangeError`)](https://github.com/socketsupply/socket/blob/v0.5.1/api/dgram.js#L1248)
...
# [FS](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L26)
...
## [`access(path, mode, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L85)
...
## [`chmod(path, mode, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L118)
...
## [`chown(path, uid, gid, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L143)
...
## [`close(fd, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L171)
...
## [`createReadStream(path, options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L223)
...
## [`createWriteStream(path, options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L266)
...
## [`fstat(fd, options, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L312)
...
## [`fsync(fd, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L339)
...
## [`ftruncate(fd, offset, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L361)
...
## [`lchown(path, uid, gid, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L389)
...
## [`link(src, dest, )`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L417)
...
## [`open(path, flags, mode, options, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L473)
...
## [`opendir(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L526)
...
## [`read(fd, buffer, offset, length, position, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L552)
...
## [`readdir(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L586)
...
## [`readFile(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L637)
...
## [`readlink(path, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L680)
...
## [`realpath(path, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L699)
...
## [`rename(src, dest, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L719)
...
## [`rmdir(path, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L742)
...
## [`stat(path, options, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L765)
...
## [`symlink(src, dest)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L799)
...
## [`unlink(path, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L840)
...
## [`writeFile(path, data, options, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L865)
...
## [`watch(, options, callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/index.js#L910)
...
# [FS.promises](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L25)
...
## [`access(path, mode, options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L86)
...
## [`chmod(path, mode)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L96)
...
## [`chown(path, uid, gid)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L119)
...
## [`copyFile(src, dest, flags)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L146)
...
## [`lchown(path, uid, gid)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L173)
...
## [`link(src, dest)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L199)
...
## [`open(path, flags, mode)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L252)
...
## [`opendir(path, options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L264)
...
## [`readdir(path, options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L276)
...
## [`readFile(path, options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L309)
...
## [`readlink(path)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L326)
...
## [`realpath(path)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L345)
...
## [`rename(src, dest)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L365)
...
## [`rmdir(path)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L386)
...
## [`stat(path, options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L405)
...
## [`symlink(src, dest)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L417)
...
## [`unlink(path)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L452)
...
## [`writeFile(path, data, options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L475)
...
## [`watch(, options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/fs/promises.js#L495)
...
# [IPC](https://github.com/socketsupply/socket/blob/v0.5.1/api/ipc.js#L37)
...
## [`emit(name, value, target, options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/ipc.js#L1100)
...
## [`send(command, value, options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/ipc.js#L1159)
...
# [Network](https://github.com/socketsupply/socket/blob/v0.5.1/api/network.js#L9)
...
# [OS](https://github.com/socketsupply/socket/blob/v0.5.1/api/os.js#L13)
...
## [`arch()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/os.js#L56)
...
## [`cpus()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/os.js#L74)
...
## [`networkInterfaces()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/os.js#L98)
...
## [`platform()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/os.js#L186)
...
## [`isWindows()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/os.js#L234)
...
## [`tmpdir()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/os.js#L246)
...
## [EOL](https://github.com/socketsupply/socket/blob/v0.5.1/api/os.js#L294)

 The operating system's end-of-line marker. `'\r\n'` on Windows and `'\n'` on POSIX.

## [`rusage()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/os.js#L306)

Get resource usage.

## [`uptime()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/os.js#L316)
...
## [`uname()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/os.js#L327)
...
# [Path](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L9)
...
## [`resolve()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L41)
...
## [`cwd(opts)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L75)
...
## [`origin()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L99)
...
## [`relative(options, from, to)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L110)
...
## [`join(options, components)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L157)
...
## [`dirname(options, components)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L210)
...
## [`basename(options, components)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L246)
...
## [`extname(options, path)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L258)
...
## [`normalize(options, path)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L269)
...
## [`format(options, path)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L319)
...
## [`parse(path)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L335)
...
## [Path](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L363)

A container for a parsed Path.

### [`from(input, cwd)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L385)
...
### [`constructor(pathname, cwd)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L408)
...
### [`isRelative()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L477)

`true` if the path is relative, otherwise `false.

### [`value()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L484)

The working value of this path.

### [`source()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L518)
...
### [`root()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L545)

Computed root in path.

### [`dir()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L566)

Computed directory name in path.

### [`base()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L601)

Computed base name in path.

### [`name()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L613)

Computed base name in path without path extension.

### [`ext()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L621)

Computed extension name in path.

### [`drive()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L641)

The computed drive, if given in the path.

### [`toURL()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/path/path.js#L648)
...
# [Process](https://github.com/socketsupply/socket/blob/v0.5.1/api/process.js#L9)
...
## [`nextTick(callback)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/process.js#L42)
...
## [`homedir()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/process.js#L71)
...
## [`hrtime(time)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/process.js#L80)
...
## [`exit(code)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/process.js#L104)
...
## [`memoryUsage()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/process.js#L116)
...
# [Test](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L17)
...
## [`getDefaultTestRunnerTimeout()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L54)
...
## [Test](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L69)



### [`constructor(name, fn, runner)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L76)
...
### [`comment(msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L127)
...
### [`plan(n)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L137)
...
### [`notDeepEqual(actual, expected, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L163)
...
### [`equal(actual, expected, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L178)
...
### [`notEqual(actual, expected, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L193)
...
### [`fail(msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L206)
...
### [`ok(actual, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L219)
...
### [`pass(msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L231)
...
### [`ifError(err, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L240)
...
### [`throws(fn, expected, message)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L253)
...
### [`sleep(ms, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L302)
...
### [`requestAnimationFrame(msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L320)
...
### [`click(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L342)
...
### [`eventClick(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L364)
...
### [`dispatchEvent(event, target, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L392)
...
### [`focus(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L412)
...
### [`blur(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L433)
...
### [`appendChild(parentSelector, el, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L487)
...
### [`removeElement(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L507)
...
### [`elementInvisible(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L547)
...
### [`waitFor(querySelectorOrFn, opts, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L571)
...
### [`waitForText(selector, opts, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L633)
...
### [`querySelector(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L670)
...
### [`querySelectorAll(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L689)
...
### [`getComputedStyle(selector, msg)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L718)
...
### [`run()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L815)

   pass: number,
   fail: number
 }>}

## [TestRunner](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L896)



### [`constructor(report)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L901)
...
### [`nextId()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L953)
...
### [`add(name, fn, only)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L963)
...
### [`run()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L985)
...
### [`onFinish())`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L1032)
...
## [`skip(_name, _fn)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L1070)
...
## [`setStrict(strict)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/test/index.js#L1076)
...
# [Window](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L12)
...
## [ApplicationWindow](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L32)

 Represents a window in the application

### [`index()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L60)
...
### [`getSize()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L68)
...
### [`getTitle()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L79)
...
### [`getStatus()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L87)
...
### [`close()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L95)
...
### [`show()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L110)
...
### [`hide()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L119)
...
### [`setTitle(title)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L129)
...
### [`setSize(opts)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L142)
...
### [`navigate(path)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L182)
...
### [`showInspector()`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L191)
...
### [`setBackgroundColor(opts)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L208)
...
### [`setContextMenu(options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L218)
...
### [`showSaveFilePicker(options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L253)
...
### [`showDirectoryFilePicker(options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L271)
...
### [`send(options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L296)
...
### [`openExternal(options)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L333)
...
### [`addListener(event, cb)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L344)
...
### [`on(event, cb)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L362)
...
### [`once(event, cb)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L379)
...
### [`removeListener(event, cb)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L395)
...
### [`removeAllListeners(event)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L408)
...
### [`off(event, cb)`](https://github.com/socketsupply/socket/blob/v0.5.1/api/window.js#L424)
