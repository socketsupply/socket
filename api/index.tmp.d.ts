...
declare module "url/urlpattern/urlpattern" {
...
declare module "url/index" {
    ...
    import { URLPattern } from "url/urlpattern/urlpattern";
    export { URLPattern };
}
declare module "url" {
...
declare module "internal/serialize" {
...
declare module "internal/symbols" {
...
declare module "ipc" {
    ...
    namespace ___home_werle_repos_socketsupply_socket_api_ipc_ { }
}
declare module "os/constants" {
...
declare module "errno" {
    ...
    export default _default;
    export type errno = import("os/constants").errno;
    import { errno as constants } from "os/constants";
}
declare module "errors" {
    ...
    namespace ___home_werle_repos_socketsupply_socket_api_errors_ { }
}
declare module "mime/params" {
...
declare module "util/types" {
    ...
    export default exports;
    import * as exports from "util/types";
    namespace ___home_werle_repos_socketsupply_socket_api_util_types_ { }
}
declare module "util" {
    ...
    import { MIMEParams } from "mime/params";
    import * as exports from "util";
    namespace ___home_werle_repos_socketsupply_socket_api_util_ { }
    export { types, MIMEType, MIMEParams };
}
declare module "async/wrap" {
    /**
...
declare module "internal/async/hooks" {
    ...
    import { Variable } from "async/context";
}
declare module "async/resource" {
    /**
     * @typedef {{
     *   triggerAsyncId?: number,
    ...
    import { executionAsyncResource } from "internal/async/hooks";
    import { executionAsyncId } from "internal/async/hooks";
    import { triggerAsyncId } from "internal/async/hooks";
    import { CoreAsyncResource } from "internal/async/hooks";
    export { executionAsyncResource, executionAsyncId, triggerAsyncId };
}
declare module "async/hooks" {
    /**
...
declare module "async" {
    ...
    import { executionAsyncResource } from "async/hooks";
    import { executionAsyncId } from "async/hooks";
    import { triggerAsyncId } from "async/hooks";
    import { createHook } from "async/hooks";
    import { AsyncHook } from "async/hooks";
    import * as exports from "async";
    namespace ___home_werle_repos_socketsupply_socket_api_async_ { }
...
declare module "application/menu" {
    /**
...
declare module "internal/events" {
    ...
    export class MenuItemEvent extends MessageEvent<any> {
         ...
         */
        constructor(type?: string | undefined, data?: object | undefined, menu?: import("application/menu").Menu);
        /**
         * The `Menu` this event has been dispatched for.
         * @type {import('../application/menu.js').Menu?}
         */
        get menu(): import("application/menu").Menu;
        /**
...
declare module "path/well-known" {
    /**
...
declare module "os" {
    ...
    export default exports;
    import constants from "os/constants";
    import * as exports from "os";
    namespace ___home_werle_repos_socketsupply_socket_api_os_ { }
}
declare module "process/signal" {
    /**
    ...
    export { constants };
    export const channel: ipc.IPCBroadcastChannel;
    ...
    import { SignalEvent } from "internal/events";
    import { signal as constants } from "os/constants";
    import ipc from "ipc";
}
declare module "internal/streams/web" {
...
declare module "internal/streams" {
    const _default: any;
    export default _default;
    import { ReadableStream } from "internal/streams/web";
    import { ReadableStreamBYOBReader } from "internal/streams/web";
    import { ReadableByteStreamController } from "internal/streams/web";
    import { ReadableStreamBYOBRequest } from "internal/streams/web";
    import { ReadableStreamDefaultController } from "internal/streams/web";
    import { ReadableStreamDefaultReader } from "internal/streams/web";
    import { WritableStream } from "internal/streams/web";
    import { WritableStreamDefaultController } from "internal/streams/web";
    import { WritableStreamDefaultWriter } from "internal/streams/web";
    import { TransformStream } from "internal/streams/web";
    import { TransformStreamDefaultController } from "internal/streams/web";
    import { ByteLengthQueuingStrategy } from "internal/streams/web";
    import { CountQueuingStrategy } from "internal/streams/web";
...
declare module "stream/web" {
    ...
    export default exports;
    import { ReadableStream } from "internal/streams";
    import { ReadableStreamBYOBReader } from "internal/streams";
    import { ReadableByteStreamController } from "internal/streams";
    import { ReadableStreamBYOBRequest } from "internal/streams";
    import { ReadableStreamDefaultController } from "internal/streams";
    import { ReadableStreamDefaultReader } from "internal/streams";
    import { WritableStream } from "internal/streams";
    import { WritableStreamDefaultController } from "internal/streams";
    import { WritableStreamDefaultWriter } from "internal/streams";
    import { TransformStream } from "internal/streams";
    import { TransformStreamDefaultController } from "internal/streams";
    import { ByteLengthQueuingStrategy } from "internal/streams";
    import { CountQueuingStrategy } from "internal/streams";
    class UnsupportedStreamInterface {
    }
    import * as exports from "stream/web";
    namespace ___home_werle_repos_socketsupply_socket_api_stream_web_ { }
    export { ReadableStream, ReadableStreamBYOBReader, ReadableByteStreamController, ReadableStreamBYOBRequest, ReadableStreamDefaultController, ReadableStreamDefaultReader, WritableStream, WritableStreamDefaultController, WritableStreamDefaultWriter, TransformStream, TransformStreamDefaultController, ByteLengthQueuingStrategy, CountQueuingStrategy };
}
...
declare module "path/win32" {
    ...
    import * as mounts from "path/mounts";
    import * as posix from "path/posix";
    import { DOWNLOADS } from "path/well-known";
    import { DOCUMENTS } from "path/well-known";
    import { RESOURCES } from "path/well-known";
    import { PICTURES } from "path/well-known";
    import { DESKTOP } from "path/well-known";
    import { VIDEOS } from "path/well-known";
    import { CONFIG } from "path/well-known";
    import { MEDIA } from "path/well-known";
    import { MUSIC } from "path/well-known";
    import { HOME } from "path/well-known";
    import { DATA } from "path/well-known";
    import { LOG } from "path/well-known";
    import { TMP } from "path/well-known";
    import * as exports from "path/win32";
    namespace ___home_werle_repos_socketsupply_socket_api_path_win32_ { }
...
declare module "path/posix" {
    ...
    import { LOG } from "path/well-known";
    import { TMP } from "path/well-known";
    import * as exports from "path/posix";
    namespace ___home_werle_repos_socketsupply_socket_api_path_posix_ { }
...
declare module "path/index" {
    ...
    import { LOG } from "path/well-known";
    import { TMP } from "path/well-known";
    import * as exports from "path/index";
    namespace ___home_werle_repos_socketsupply_socket_api_path_index_ { }
...
declare module "path" {
    ...
    import { mounts } from "path/index";
    import { DOWNLOADS } from "path/index";
    import { DOCUMENTS } from "path/index";
    import { RESOURCES } from "path/index";
    import { PICTURES } from "path/index";
    import { DESKTOP } from "path/index";
    import { VIDEOS } from "path/index";
    import { CONFIG } from "path/index";
    import { MEDIA } from "path/index";
    import { MUSIC } from "path/index";
    import { HOME } from "path/index";
    import { DATA } from "path/index";
    import { LOG } from "path/index";
    import { TMP } from "path/index";
...
declare module "fs/constants" {
    ...
    namespace ___home_werle_repos_socketsupply_socket_api_fs_constants_ { }
}
declare module "fs/stream" {
    ...
    export default exports;
    export type FileHandle = import("fs/handle").FileHandle;
    import { Readable } from "stream";
    import { Writable } from "stream";
    import * as exports from "fs/stream";
    namespace ___home_werle_repos_socketsupply_socket_api_fs_stream_ { }
}
declare module "fs/flags" {
    export function normalizeFlags(flags: any): number;
    export default exports;
    import * as exports from "fs/flags";
    namespace ___home_werle_repos_socketsupply_socket_api_fs_flags_ { }
}
declare module "diagnostics/channels" {
    /**
...
declare module "diagnostics/metric" {
    export class Metric {
        init(): void;
...
declare module "diagnostics/window" {
...
declare module "diagnostics/runtime" {
    /**
...
declare module "diagnostics/index" {
    /**
     * @param {string} name
    ...
    import runtime from "diagnostics/runtime";
    namespace ___home_werle_repos_socketsupply_socket_api_diagnostics_index_ { }
...
declare module "fs/stats" {
    ...
    namespace ___home_werle_repos_socketsupply_socket_api_fs_stats_ { }
}
declare module "fs/fds" {
    const _default: {
        types: Map<any, any>;
        fds: Map<any, any>;
        ids: Map<any, any>;
...
declare module "fs/handle" {
    ...
    namespace ___home_werle_repos_socketsupply_socket_api_fs_handle_ { }
}
declare module "fs/dir" {
    /**
    ...
    namespace ___home_werle_repos_socketsupply_socket_api_fs_dir_ { }
}
...
declare module "fs/promises" {
    ...
    import { Stats } from "fs/stats";
    import { Watcher } from "fs/watcher";
    import bookmarks from "fs/bookmarks";
    ...
    namespace ___home_werle_repos_socketsupply_socket_api_fs_promises_ { }
...
declare module "fs/index" {
    ...
    namespace ___home_werle_repos_socketsupply_socket_api_fs_index_ { }
...
declare module "external/libsodium/index" {
    const _default: any;
    export default _default;
}
declare module "crypto/sodium" {
    export {};
}
declare module "crypto" {
    ...
    namespace ___home_werle_repos_socketsupply_socket_api_crypto_ { }
}
declare module "ai" {
    /**
    ...
    export default exports;
    import { EventEmitter } from "events";
    import * as exports from "ai";
    namespace ___home_werle_repos_socketsupply_socket_api_ai_ { }
}
declare module "window/constants" {
    ...
    export default exports;
    import * as exports from "window/constants";
    namespace ___home_werle_repos_socketsupply_socket_api_window_constants_ { }
}
declare module "application/client" {
    /**
     * @typedef {{
     *  id?: string | null,
     *  type?: 'window' | 'worker',
...
declare module "window/hotkey" {
    ...
    export class Bindings extends EventTarget {
         ...
         */
        onHotKey(event: import("internal/events").HotKeyEvent): boolean;
        /**
    ...
    import { HotKeyEvent } from "internal/events";
}
declare module "window" {
    ...
    export class ApplicationWindow {
        ...
        static hotkey: import("window/hotkey").Bindings;
         ...
         */
        get hotkey(): import("window/hotkey").Bindings;
        get state(): {
            [x: string]: any;
        };
        /**
    ...
    import hotkey from "window/hotkey";
...
declare module "application" {
    ...
    export default exports;
    import { ApplicationURLEvent } from "internal/events";
    import ApplicationWindow from "window";
    import ipc from "ipc";
    import client from "application/client";
    import menu from "application/menu";
    import * as exports from "application";
    namespace ___home_werle_repos_socketsupply_socket_api_application_ { }
    export { client, menu };
}
declare module "test/fast-deep-equal" {
...
declare module "async_hooks" {
    ...
    import { triggerAsyncId } from "async/hooks";
    import { createHook } from "async/hooks";
    import * as exports from "async_hooks";
    namespace ___home_werle_repos_socketsupply_socket_api_async_hooks_ { }
...
declare module "bluetooth" {
    ...
    import { EventEmitter } from "events";
    import ipc from "ipc";
    namespace ___home_werle_repos_socketsupply_socket_api_bluetooth_ { }
}
...
declare module "shared-worker/index" {
...
declare module "internal/promise" {
    ...
    import * as asyncHooks from "internal/async/hooks";
}
declare module "internal/globals" {
    /**
...
declare module "vm" {
     ...
     * @return {Promise<import('./window.js').ApplicationWindow}
     */
    export function getContextWindow(): Promise<import("window").ApplicationWindow>;
    /**
    ...
    import { SharedWorker } from "shared-worker/index";
}
declare module "worker_threads/init" {
...
declare module "worker_threads" {
    ...
    export class Worker extends EventEmitter {
         ...
         */
        onProcessEnvironmentEvent(event: import("process").ProcessEnvironmentEvent): void;
        /**
    ...
    import { Writable } from "stream";
    import { Readable } from "stream";
    import { SHARE_ENV } from "worker_threads/init";
    import init from "worker_threads/init";
...
declare module "child_process" {
    ...
    export class Pipe extends AsyncResource {
         ...
         * @type {import('./process')}
         */
        get process(): typeof import("process");
        /**
         * Destroys the pipe
         */
        destroy(): void;
...
declare module "timers/platform" {
...
declare module "timers/scheduler" {
...
declare module "timers/index" {
    export function setTimeout(callback: any, delay: any, ...args: any[]): import("timers/timer").Timer;
    export function clearTimeout(timeout: any): void;
    export function setInterval(callback: any, delay: any, ...args: any[]): import("timers/timer").Timer;
    export function clearInterval(interval: any): void;
    export function setImmediate(callback: any, ...args: any[]): import("timers/timer").Timer;
    ...
    export default _default;
    import platform from "timers/platform";
    import promises from "timers/promises";
    import scheduler from "timers/scheduler";
}
declare module "timers" {
    export * from "timers/index";
    export default exports;
    import * as exports from "timers/index";
}
declare module "internal/conduit" {
    /**
...
declare module "dns/promises" {
    ...
    namespace ___home_werle_repos_socketsupply_socket_api_dns_promises_ { }
}
declare module "dns/index" {
    /**
    ...
    namespace ___home_werle_repos_socketsupply_socket_api_dns_index_ { }
}
declare module "dns" {
...
declare module "dgram" {
    ...
    import { EventEmitter } from "events";
    import { Conduit } from "internal/conduit";
    import { InternalError } from "errors";
    import * as exports from "dgram";
    namespace ___home_werle_repos_socketsupply_socket_api_dgram_ { }
}
...
declare module "mime" {
    export * from "mime/index";
    export default exports;
    import * as exports from "mime/index";
}
...
declare module "service-worker/env" {
    /**
    ...
    export class Environment extends EventTarget {
         ...
         */
        get database(): import("internal/database").Database;
        /**
...
declare module "service-worker/debug" {
    export function debug(...args: any[]): void;
    export default debug;
}
declare module "service-worker/state" {
    export const channel: ipc.IPCBroadcastChannel;
    export const state: any;
    export default state;
    import ipc from "ipc";
}
declare module "service-worker/clients" {
    export class Client {
        constructor(options: any);
        get id(): any;
        get url(): any;
...
declare module "service-worker/context" {
    /**
    ...
    export class Context {
         ...
         */
        constructor(event: import("service-worker/events").ExtendableEvent);
        /**
         ...
         */
        client(): Promise<import("service-worker/clients").Client>;
        #private;
    }
    namespace _default {
        export { Context };
...
declare module "service-worker/events" {
    ...
    export class ExtendableMessageEvent extends ExtendableEvent {
         ...
         */
        get source(): import("service-worker/clients").Client;
        /**
         * @type {string?}
         */
        get origin(): string;
...
declare module "http/adapters" {
    ...
    export class ServerAdapter extends EventTarget {
         ...
         */
        constructor(server: import("http").Server, httpInterface: HTTPModuleInterface);
        /**
         * A readonly reference to the underlying HTTP(S) server
         * for this adapter.
         * @type {import('../http.js').Server}
         */
        get server(): import("http").Server;
        /**
         ...
         */
        get context(): import("async/context").Variable<any>;
        /**
    ...
    export class ServiceWorkerServerAdapter extends ServerAdapter {
         ...
         */
        onInstall(event: import("service-worker/events").ExtendableEvent): Promise<void>;
        /**
         * Handles the 'activate' service worker event.
         * @ignore
         * @param {import('../service-worker/events.js').ExtendableEvent} event
         */
        onActivate(event: import("service-worker/events").ExtendableEvent): Promise<void>;
        /**
    ...
    export type HTTPModuleInterface = {
        Connection: typeof import("http").Connection;
        globalAgent: import("http").Agent;
        IncomingMessage: typeof import("http").IncomingMessage;
        ServerResponse: typeof import("http").ServerResponse;
        STATUS_CODES: object;
        METHODS: string[];
    };
}
declare module "http" {
    ...
    export class IncomingMessage extends Readable {
         ...
         */
        get context(): typeof import("async/context").Variable;
        /**
    ...
    import { AsyncResource } from "async/resource";
    import * as exports from "http";
    namespace ___home_werle_repos_socketsupply_socket_api_http_ { }
}
...
declare module "latica/encryption" {
    /**
...
declare module "latica/cache" {
    ...
    import { Packet } from "latica/packets";
    import { Buffer } from "buffer";
}
declare module "latica/nat" {
    /**
...
declare module "latica/index" {
    ...
    export default Peer;
    import { Packet } from "latica/packets";
    import { sha256 } from "latica/packets";
    import { Cache } from "latica/cache";
    import { Encryption } from "latica/encryption";
    import * as NAT from "latica/nat";
    import { Buffer } from "buffer";
    import { PacketPing } from "latica/packets";
    import { PacketPublish } from "latica/packets";
    export { Packet, sha256, Cache, Encryption, NAT };
}
declare module "latica/proxy" {
...
declare module "network" {
    ...
    import { Cache } from "latica/index";
    import { sha256 } from "latica/index";
    import { Encryption } from "latica/index";
    import { Packet } from "latica/index";
    import { NAT } from "latica/index";
...
declare module "service-worker" {
    ...
    export default _default;
    import { Environment } from "service-worker/env";
    import { ExtendableEvent } from "service-worker/events";
    import { FetchEvent } from "service-worker/events";
    import { Context } from "service-worker/context";
...
declare module "commonjs/builtins" {
    /**
...
declare module "commonjs/cache" {
    ...
    export class Cache {
         ...
         */
        get loader(): import("commonjs/loader").Loader;
        /**
    ...
    export type CacheOptions = {
        types?: object;
        loader?: import("commonjs/loader").Loader;
    };
    export type StorageOptions = {
        name: string;
    };
}
declare module "commonjs/loader" {
    /**
     * @typedef {{
    ...
    import { Headers } from "ipc";
    import URL from "url";
    import { Cache } from "commonjs/cache";
}
declare module "commonjs/package" {
    /**
     * @ignore
     * @param {string} source
     * @return {boolean}
    ...
    export type PackageLoadOptions = import("commonjs/loader").RequestOptions & {
        type?: "commonjs" | "module";
        prefix?: string;
    };
    ...
    import URL from "url";
    import { Loader } from "commonjs/loader";
}
declare module "commonjs/module" {
    ...
    export type RequireFunction = import("commonjs/require").RequireFunction;
    export type PackageOptions = import("commonjs/package").PackageOptions;
    export type CreateRequireOptions = {
        prefix?: string;
        request?: import("commonjs/loader").RequestOptions;
        builtins?: object;
    };
    ...
    import { Package } from "commonjs/package";
    import { Loader } from "commonjs/loader";
    import process from "process";
}
declare module "commonjs/require" {
    /**
     * Factory for creating a `require()` function based on a module context.
     * @param {CreateRequireOptions} options
     * @return {RequireFunction}
    ...
    export class Meta {
         ...
         */
        constructor(module: import("commonjs/module").Module);
        /**
    ...
    export type RequireResolver = (arg0: string, arg1: import("commonjs/module").Module, arg2: (arg0: string) => any) => any;
    export type CreateRequireOptions = {
        module: import("commonjs/module").Module;
        prefix?: string;
        request?: import("commonjs/loader").RequestOptions;
        builtins?: object;
        resolvers?: RequireFunction[];
    ...
    export type PackageOptions = import("commonjs/package").PackageOptions;
    export type PackageResolveOptions = import("commonjs/package").PackageResolveOptions;
    export type RequireOptions = ResolveOptions & {
        resolvers?: RequireResolver[];
        importmap?: import("commonjs/module").ImportMap;
        cache?: boolean;
    };
}
declare module "commonjs" {
    export default exports;
    import * as exports from "commonjs";
    import builtins from "commonjs/builtins";
    import Cache from "commonjs/cache";
    import createRequire from "commonjs/require";
    import Loader from "commonjs/loader";
    import Module from "commonjs/module";
    import Package from "commonjs/package";
    namespace ___home_werle_repos_socketsupply_socket_api_commonjs_ { }
    export { builtins, Cache, createRequire, Loader, Module, Package };
}
declare module "fetch/fetch" {
...
declare module "fetch/index" {
    ...
    import { Headers } from "fetch/fetch";
    import { Request } from "fetch/fetch";
    import { Response } from "fetch/fetch";
...
declare module "index" {
    import { network } from "node/index";
    import { Cache } from "node/index";
    import { sha256 } from "node/index";
    import { Encryption } from "node/index";
    import { Packet } from "node/index";
    import { NAT } from "node/index";
    export { network, Cache, sha256, Encryption, Packet, NAT };
}
declare module "latica" {
    export * from "latica/index";
    export default def;
    import def from "latica/index";
}
declare module "module" {
    export const builtinModules: any;
    export default Module;
    export type ModuleOptions = import("commonjs/module").ModuleOptions;
    export type ModuleResolver = import("commonjs/module").ModuleResolver;
    export type ModuleLoadOptions = import("commonjs/module").ModuleLoadOptions;
    export type RequireFunction = import("commonjs/module").RequireFunction;
    export type CreateRequireOptions = import("commonjs/module").CreateRequireOptions;
    import { createRequire } from "commonjs/module";
    import { Module } from "commonjs/module";
    import builtins from "commonjs/builtins";
    import { isBuiltin } from "commonjs/builtins";
    export { createRequire, Module, builtins, isBuiltin };
}
declare module "node-esm-loader" {
    export function resolve(specifier: any, ctx: any, next: any): Promise<any>;
    export default resolve;
}
declare module "internal/permissions" {
    /**
...
declare module "protocol-handlers" {
    /**
...
declare module "signal" {
    ...
    import signal from "process/signal";
}
declare module "service-worker/instance" {
...
declare module "worker" {
    ...
    import { SharedWorker } from "shared-worker/index";
    import { ServiceWorker } from "service-worker/instance";
    import { Worker } from "worker_threads";
    export { SharedWorker, ServiceWorker, Worker };
}
declare module "child_process/worker" {
    export {};
}
declare module "internal/callsite" {
    /**
...
declare module "internal/geolocation" {
    /**
...
declare module "internal/post-message" {
    const _default: any;
    export default _default;
}
declare module "service-worker/notification" {
...
declare module "service-worker/registration" {
...
declare module "service-worker/container" {
    /**
...
declare module "internal/service-worker" {
    export const serviceWorker: ServiceWorkerContainer;
    export default serviceWorker;
    import { ServiceWorkerContainer } from "service-worker/container";
}
declare module "internal/webassembly" {
    /**
...
declare module "internal/scheduler" {
...
declare module "internal/pickers" {
    /**
     * @typedef {{
     *   id?: string,
     *   mode?: 'read' | 'readwrite'
...
declare module "internal/primitives" {
...
declare module "internal/worker" {
...
declare module "npm/service-worker" {
    /**
     * @ignore
     * @param {Request}
     * @param {object} env
     ...
     */
    export function onRequest(request: any, env: object, ctx: import("service-worker/context").Context): Promise<Response | null>;
    /**
     ...
     * @return {Response?}
     */
    export default function _default(request: Request, env: object, ctx: import("service-worker/context").Context): Response | null;
}
declare module "service-worker/global" {
    export class ServiceWorkerGlobalScope {
        ...
        get clients(): import("service-worker/clients").Clients;
...
declare module "service-worker/init" {
    ...
    export function onShowNotification(event: any, target: any): any;
...
declare module "service-worker/main" {
    export {};
}
...
declare module "service-worker/storage" {
    /**
...
declare module "service-worker/worker" {
...
declare module "shared-worker/debug" {
    export function debug(...args: any[]): void;
    export default debug;
}
declare module "shared-worker/global" {
...
declare module "shared-worker/init" {
    ...
    const _default: any;
    export default _default;
    import { channel } from "shared-worker/index";
}
declare module "shared-worker/main" {
    export {};
}
declare module "shared-worker/state" {
    export const state: any;
    export default state;
}
declare module "shared-worker/worker" {
    export function onReady(): void;
...
declare module "test/harness" {
     ...
     */
    export function wrapHarness<T extends Harness>(tapzero: typeof import("test/index"), harnessClass: new (options: object) => T): TapeTestFn<T>;
    export default exports;
    /**
     * @template {Harness} T
     */
    ...
    namespace ___home_werle_repos_socketsupply_socket_api_test_harness_ { }
}
declare module "vm/init" {
    export {};
}
declare function isTypedArray(object: any): boolean;
declare function isTypedArray(object: any): boolean;
