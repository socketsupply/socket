...
export class Peer {
  ...
  dgram = () => { throw new Error('dgram implementation required in constructor as second argument') }
  ...
  async init (cb) {
    ...
    if (this.indexed && this.onReady) return this.onReady(this.getInfo())
  }
      ...
      if (!this.reflectionFirstResponder) {
        ...
        this._setTimeout(async () => {
          ...
          if (NAT.isValid(natType)) {
            ...
            if (this.onReady) this.onReady(this.getInfo())
          }
