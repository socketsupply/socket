class Op < Formula
  ...
  homepage "https://github.com/socketsupply/socket-sdk"
  url "https://github.com/socketsupply/socket-sdk/archive/0.1.0.tar.gz"
  sha256 "0d2330e3c46ce21d7fa3d29f0f99b9527eb5ab323b1efb9b1a0e6915779c74d6"
  license "MIT"
  head "https://github.com/socketsupply/socket-sdk.git", branch: "main"
