...
test('index export', async (t) => {
  ...
  assert.strictEqual(await redirect('/another-file.html', __dirname), '/another-file.html')
  assert.strictEqual(await redirect('/an-index-file/', __dirname), '/an-index-file/index.html')
  assert.strictEqual(await redirect('/an-index-file', __dirname), '/an-index-file/index.html')
  assert.strictEqual(await redirect('/an-index-file/a-html-file', __dirname), '/an-index-file/a-html-file.html')
})
