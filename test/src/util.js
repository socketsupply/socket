...
test('util.isValidPercentageValue', (t) => {
  ...
  t.equal(util.isValidPercentageValue('0.00%'), true, '0.00% is a valid percentage value')
  ...
  t.equal(util.isValidPercentageValue('0x10%'), false, '0x10% is not a valid percentage value')
})
