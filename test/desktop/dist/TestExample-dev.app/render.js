...
`),null,!1):this._prop(n);case"[object Object]":case"[object Function]":return this._prop(n);case"[object NamedNodeMap]":return this._prop(p._normalizeAttrs(n));case"[object Number]":return`${n}__float`;case"[object String]":return p.escape(n);case"[object Boolean]":return`${n}__boolean`;case"[object Null]":return`${n}__null`;case"[object HTMLElement]":return this._placehold([n])}return typeof n=="object"&&n&&n.nodeType===1&&typeof n.cloneNode=="function"?this._placehold([n]):n},"refs"),o=[];for(let n=0;n<t.length-1;n++)o.push(t[n],i(e[n]));o.push(t[t.length-1]);let s=o.join("").replace(p.SPREAD,(n,c)=>{let l=p._data[c.split("__")[1]][c];return Object.entries(l).map(([u,d])=>{let m=u.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();return d===!0?m:d?`${m}="${p.escape(String(d))}"`:""}).filter(Boolean).join(" ")});return new O(s,t,!1)}scheduleReRender(t){return this.pendingReRender?this.pendingReRender:(this.pendingReRender=new Promise(e=>setTimeout(()=>{if(!this.isInDocument(this.shadowRoot||this))return;let i=this._set(this.shadowRoot||this,this.render);if(this.pendingReRender=null,i&&i.then)return i.then(()=>{this.updated&&this.updated(t),e()});this.updated&&this.updated(t),e()},0)),this.pendingReRender)}reRender(t=this.props){let e={...this.props};return this.props=typeof t=="function"?t(e):t,this.scheduleReRender(e)}handleEvent(t){this[t.type](t)}_drainIterator(t,e){return e.next().then(i=>{if(this._set(t,null,i.value),!i.done)return this._drainIterator(t,e)})}_set(t,e,i=""){for(let o of t.querySelectorAll(p._tags)){if(!o.isTonicComponent)continue;let s=o.getAttribute("id");!s||!p._refIds.includes(s)||(p._states[s]=o.state)}if(e instanceof p.AsyncFunction)return e.call(this,this.html,this.props).then(o=>this._apply(t,o));if(e instanceof p.AsyncFunctionGenerator)return this._drainIterator(t,e.call(this));e===null?this._apply(t,i):e instanceof Function&&this._apply(t,e.call(this,this.html,this.props)||"")}_apply(t,e){if(e&&e.isTonicTemplate?e=e.rawText:typeof e=="string"&&(e=p.escape(e)),typeof e=="string"){if(this.stylesheet&&(e=`<style nonce=${p.nonce||""}>${this.stylesheet()}</style>${e}`),t.innerHTML=e,this.styles){let s=this.styles();for(let n of t.querySelectorAll("[styles]"))for(let c of n.getAttribute("styles").split(/\s+/))Object.assign(n.style,s[c.trim()])}let i=p._children[this._id]||{},o=a((s,n)=>{if(s.nodeType===3){let l=s.textContent.trim();i[l]&&n(s,i[l],l)}let c=s.childNodes;if(!!c)for(let l=0;l<c.length;l++)o(c[l],n)},"walk");o(t,(s,n,c)=>{for(let l of n)s.parentNode.insertBefore(l,s);delete p._children[this._id][c],s.parentNode.removeChild(s)})}else t.innerHTML="",t.appendChild(e.cloneNode(!0))}connectedCallback(){this.root=this.shadowRoot||this,super.id&&!p._refIds.includes(super.id)&&p._refIds.push(super.id);let t=a(e=>e.replace(/-(.)/g,(i,o)=>o.toUpperCase()),"cc");for(let{name:e,value:i}of this.attributes){let o=t(e),s=this.props[o]=i;if(/__\w+__\w+__/.test(s)){let{1:n}=s.split("__");this.props[o]=p._data[n][s]}else if(/\d+__float/.test(s))this.props[o]=parseFloat(s,10);else if(s==="null__null")this.props[o]=null;else if(/\w+__boolean/.test(s))this.props[o]=s.includes("true");else if(/placehold:\w+:\w+__/.test(s)){let{1:n}=s.split(":");this.props[o]=p._children[n][s][0]}}if(this.props=Object.assign(this.defaults?this.defaults():{},this.props),this._id=this._id||p._createId(),this.willConnect&&this.willConnect(),!!this.isInDocument(this.root)){if(!this.preventRenderOnReconnect){this._source?this.innerHTML=this._source:this._source=this.innerHTML;let e=this._set(this.root,this.render);if(e&&e.then)return e.then(()=>this.connected&&this.connected())}this.connected&&this.connected()}}isInDocument(t){let e=t.getRootNode();return e===document||e.toString()==="[object ShadowRoot]"}disconnectedCallback(){this.disconnected&&this.disconnected(),delete p._data[this._id],delete p._children[this._id]}};a(p,"Tonic");p.prototype.isTonicComponent=!0;Object.assign(p,{_tags:"",_refIds:[],_data:{},_states:{},_children:{},_reg:{},_stylesheetRegistry:[],_index:0,version:typeof Mt!="undefined"?Rt().version:null,SPREAD:/\.\.\.\s?(__\w+__\w+__)/g,ESC:/["&'<>`/]/g,AsyncFunctionGenerator:async function*(){}.constructor,AsyncFunction:async function(){}.constructor,MAP:{'"':"&quot;","&":"&amp;","'":"&#x27;","<":"&lt;",">":"&gt;","`":"&#x60;","/":"&#x2F;"}});typeof Q=="object"&&(Q.exports=p)});var Dt=v((po,Nt)=>{var T=y(),tt=class extends T{defaults(){return{multiple:!1}}static stylesheet(){return`
    ...
    `}};a(et,"TonicAccordionSection");Nt.exports={TonicAccordion:tt,TonicAccordionSection:et}});var jt=v((ho,Vt)=>{var Je=y(),it=class extends Je{defaults(){return{count:0}}get value(){return this.state.count}set value(t){this.state.count=t,this.reRender()}static stylesheet(){return`
      tonic-badge * {
    ...
    `}loading(t){this.classList[t?"add":"remove"]("tonic--loading")}click(t){let e=this.props.disabled==="true",i=this.props.async==="true",o=this.props.href;if(i&&!e&&this.loading(!0),o){let s=this.getAttribute("target");s&&s!=="_self"?window.open(o):window.open(o,"_self")}}styles(){let{width:t,height:e,margin:i,radius:o,borderWidth:s}=this.props;return{button:{width:t,height:e,borderRadius:o,borderWidth:s},wrapper:{width:t,height:e,margin:i}}}render(){let{value:t,type:e,disabled:i,autofocus:o,active:s,async:n,fill:c,tabindex:l,size:u,symbolId:d}=this.props,m=[];s&&m.push("tonic--active"),m=m.join(" "),l&&this.removeAttribute("tabindex");let h="";return e==="icon"?h=this.html`
      ...
      <div class="tonic--button--wrapper" styles="wrapper">
        <button ... ${{styles:"button",async:String(n),disabled:i&&i!=="false",autofocus:o==="true"?"autofocus":"",value:t,type:e,tabindex:l,class:m}}>${h}</button>
      </div>
    `}};a(ot,"TonicButton");Ot.exports={TonicButton:ot}});var Ht=v((fo,Ft)=>{var ti=y(),st=class extends ti{static stylesheet(){return`
      tonic-chart {
        display: inline-block;
        position: relative;
      }
    ...
    `}};a(st,"TonicChart");Ft.exports={TonicChart:st}});var Pt=v((mo,Tt)=>{var ei=y(),nt=class extends ei{constructor(){super();this._modified=!1}get value(){let t=this.state,e=this.props,i=typeof e.checked!="undefined"?e.checked:e.value,o=typeof t.checked!="undefined"?t.checked:t.value,s;return this._modified?s=typeof o!="undefined"?o:i:s=typeof i!="undefined"?i:o,s===!0||s==="true"}set value(t){this._setValue(t)}async _setValue(t){this._modified=!0,this.state._changing=!0;let e=t===!0||t==="true";this.state.checked=e,this.props.checked=e,await this.reRender()}defaults(){return{disabled:!1,size:"18px"}}static stylesheet(){return`
    ...
    `}};a(nt,"TonicCheckbox");Tt.exports={TonicCheckbox:nt}});var at=v((bo,Bt)=>{var P=y(),rt=class extends P{constructor(){super();if(this.classList.add("tonic--dialog"),this.setAttribute("hidden",!0),!document.querySelector(".tonic--dialog--overlay")){let n=document.createElement("div");n.classList="tonic--dialog--overlay",n.textContent=" ",document.body.appendChild(n)}this.closeIcon=document.createElement("div"),this.closeIcon.className="tonic--dialog--close";let t="http://www.w3.org/2000/svg",e="http://www.w3.org/1999/xlink",i=document.createElementNS(t,"svg"),o=document.createElementNS(t,"use");this.closeIcon.appendChild(i),i.appendChild(o),o.setAttributeNS(e,"href","#close"),o.setAttributeNS(e,"xlink:href","#close");let s="var(--tonic-primary, #333)";o.setAttribute("color",s),o.setAttribute("fill",s)}defaults(){return{width:"450px",height:"auto",overlay:!0,backgroundColor:"rgba(0, 0, 0, 0.5)"}}_getZIndex(){return Array.from(document.querySelectorAll("body *")).map(t=>parseFloat(window.getComputedStyle(t).zIndex)).reduce((t,e=Number.MIN_SAFE_INTEGER)=>isNaN(t)||t<e?e:t)}static stylesheet(){return`
      .tonic--dialog {
    ...
    `}show(){let t=this._getZIndex();if(this.appendChild(this.closeIcon),this.removeAttribute("hidden"),this.props.overlay!=="false"){let e=document.querySelector(".tonic--dialog--overlay");e.classList.add("tonic--show"),e.style.zIndex=t}return this.style.zIndex=t+100,new Promise(e=>{this.props.widthMobile&&document.body.clientWidth<500&&(this.props.width=this.props.widthMobile),this.style.width=this.props.width,this.style.height=this.props.height;let i=a(()=>{clearTimeout(o),e()},"done"),o=setTimeout(i,512);this.addEventListener("animationend",i,{once:!0}),this.classList.remove("tonic--hide"),this.classList.add("tonic--show"),this._escapeHandler=s=>{s.keyCode===27&&this.hide()},document.addEventListener("keyup",this._escapeHandler)})}hide(){let t=document.querySelector(".tonic--dialog--overlay");return t.classList.remove("tonic--show"),t.style.zIndex=-1,new Promise(e=>{this.style.zIndex=-1,document.removeEventListener("keyup",this._escapeHandler);let i=a(()=>{clearTimeout(o),this.setAttribute("hidden",!0),e()},"done"),o=setTimeout(i,512);this.addEventListener("animationend",i,{once:!0}),this.classList.remove("tonic--show"),this.classList.add("tonic--hide")})}event(t){let e=this;return{then(i){let o=a(n=>{n.keyCode===27&&i({})},"resolver"),s=a(n=>{let c=P.match(n.target,".tonic--dialog--close"),l=P.match(n.target,"[value]");if((c||l)&&(e.removeEventListener(t,s),document.removeEventListener("keyup",o)),c)return i({});l&&i({[n.target.value]:!0})},"listener");document.addEventListener("keyup",o),e.addEventListener(t,s)}}}click(t){P.match(t.target,".tonic--dialog--close")&&this.hide()}updated(){this.appendChild(this.closeIcon)}render(){return this.html`
      ${this.children}
    `}};a(rt,"TonicDialog");Bt.exports={TonicDialog:rt}});var Ut=v((go,Wt)=>{var Xt=y(),Y={type:"TonicForm_NON_EXISTANT"},_=class extends Xt{static isNumber(t){return!isNaN(Number(t))}static getPropertyValue(t,e){if(!e)return Y;let i=e.split("."),o=t;for(let s of i){if(!o)return Y;o=o[s]}return o}static setPropertyValue(t,e,i){if(!e)return;let o=e.split("."),s=t,n=o.pop();if(!!n){for(let c=0;c<o.length;c++){let l=o[c],u=o[c+1]||n;s[l]||(s[l]=_.isNumber(u)?[]:{}),s=s[l]}return s[n]=i,t}}setData(t){this.state=t}getData(){return this.value}getElements(){return[...this.querySelectorAll("[data-key]")]}get value(){let t=this.getElements();for(let e of t)_.setPropertyValue(this.state,e.dataset.key,e.value);return this.state}reset(t={}){let e=this.getElements();this.state=t;for(let i of e)i.value="",i.state.edited&&(i.state.edited=!1,i.removeAttribute("edited"));return this.state}set value(t){if(typeof t!="object")return;let e=this.getElements();for(let i of e){let o=_.getPropertyValue(t,i.dataset.key);o!==Y&&(i.value=o||"")}this.state=t}setValid(){let t=this.getElements();for(let e of t)e.setValid&&(e.state.edited=!1,e.removeAttribute("edited"),e.setValid())}input(t){this.change(t)}change(t){let e=Xt.match(t.target,"[data-key]");!e||_.setPropertyValue(this.state,e.dataset.key,e.value)}validate({decorate:t=!0}={}){this.getData();let e=this.getElements(),i=!0;for(let o of e){if(!o.setInvalid)continue;let s="";o.tagName==="TONIC-INPUT"?s="input":o.tagName==="TONIC-TEXTAREA"?s="textarea":o.tagName==="TONIC-SELECT"?s="select":(o.tagName==="TONIC-CHECKBOX"||o.tagName==="TONIC-TOGGLE")&&(s="checkbox");let n=s?o.querySelector(s):o;if(!!n.checkValidity){n.checkValidity();for(let c in n.validity){if(c==="valid"||c==="customError"||!n.validity[c]){t&&o.setValid();continue}t&&o.setInvalid(o.props.errorMessage||"Required"),i=!1}}}return i}connected(){if(!this.props.fill)return;let t=this.getElements();for(let e of t){let i=e.dataset.key,o=_.getPropertyValue(this.state,i);o===Y&&(o=""),e.value=o||e.value||""}}render(){return this.html`
      ${this.childNodes}
    `}};a(_,"TonicForm");_.NON_EXISTANT=Y;Wt.exports={TonicForm:_}});var Zt=v((vo,Gt)=>{var ii=y(),ct=class extends ii{defaults(){return{size:"25px",fill:"var(--tonic-primary, #333)"}}static stylesheet(){return`
      tonic-icon {
        vertical-align: middle;
      }
    ...
    `}};a(lt,"TonicInput");Kt.exports={TonicInput:lt}});var te=v((xo,Qt)=>{var si=y(),dt=class extends si{constructor(){super();this.attachShadow({mode:"open"}),this.setAttribute("id",Math.random().toString(16).slice(2,-8))}stylesheet(){return`
      .outer {
        position: absolute;
        top: 0;
        bottom: 0;
    ...
    `}};a(dt,"TonicLoader");Qt.exports={TonicLoader:dt}});var ie=v((wo,ee)=>{var{TonicDialog:ni}=at(),pt=class extends ni{constructor(){super();this.classList.add("tonic--panel")}defaults(){return{position:"right"}}stylesheet(){let{width:t,position:e}=this.props,i=[0,t];return e!=="right"&&(i[1]=`-${t}`),`
    ...
    `}};a(ht,"TonicPopover");se.exports={TonicPopover:ht}});var ae=v(($o,re)=>{var ri=y(),z=class extends ri{get value(){return this.state.data||this.props.src}defaults(){return{src:z.svg.default(),size:"50px",radius:"5px"}}static stylesheet(){return`
      tonic-profile-image {
        display: inline-block;
      }
...
`);re.exports={TonicProfileImage:z}});var le=v((Eo,ce)=>{var ai=y(),ut=class extends ai{set value(t){this.setProgress(t)}get value(){return typeof this.state.progress!="undefined"?this.state.progress:this.props.progress}defaults(){return{width:"280px",height:"15px",progress:0}}static stylesheet(){return`
      tonic-progress-bar {
        display: inline-block;
        user-select: none;
        -webkit-user-select: none;
    ...
    `}getLabelValue(t){return this.setLabel?this.setLabel(t):this.props.label?this.props.label.replace(/%\w/,t):t}renderLabel(){if(!this.props.label)return"";let t=this.props.value;return this.html`<label>${this.getLabelValue(t)}</label>`}styles(){let{width:t}=this.props;return{width:{width:t}}}connected(){this.setValue(this.state.value)}render(){let{width:t,height:e,disabled:i,theme:o,min:s,max:n,step:c,label:l,id:u,tabindex:d}=this.props;t&&(this.style.width=t),e&&(this.style.width=e),o&&this.classList.add(`tonic--theme--${o}`),l||this.classList.add("tonic--no-label"),d&&this.removeAttribute("tabindex");let m=this.props.value||this.state.value;return typeof this.state.value=="undefined"&&(this.state.value=m),this.html`
      ${this.renderLabel()}
      <div class="tonic--wrapper" styles="width">
        <input ... ${{type:"range",styles:"width",id:u,value:m,tabindex:d,step:c,min:s,max:n,disabled:i==="true"}}/>
      </div>
    `}};a(ft,"TonicRange");de.exports={TonicRange:ft}});var me=v((So,fe)=>{var li=y(),he=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],ue=["January","February","March","April","May","June","July","August","September","October","November","December"];function V(r){return`0${r}`.slice(-2)}a(V,"pad");function mt(r,t){let e=r.getDay(),i=r.getDate(),o=r.getMonth(),s=r.getFullYear(),n=r.getHours(),c=r.getMinutes(),l=r.getSeconds();return t.replace(/%([%aAbBcdeHIlmMpPSwyYZz])/g,u=>{let d;switch(u[1]){case"%":return"%";case"a":return he[e].slice(0,3);case"A":return he[e];case"b":return ue[o].slice(0,3);case"B":return ue[o];case"c":return r.toString();case"d":return V(i);case"e":return String(i);case"H":return V(n);case"I":return V(mt(r,"%l"));case"l":return String(n===0||n===12?12:(n+12)%12);case"m":return V(o+1);case"M":return V(c);case"p":return n>11?"PM":"AM";case"P":return n>11?"pm":"am";case"S":return V(l);case"w":return String(e);case"y":return V(s%100);case"Y":return String(s);case"Z":return d=r.toString().match(/\((\w+)\)$/),d?d[1]:"";case"z":return d=r.toString().match(/\w([+-]\d\d\d\d) /),d?d[1]:""}return""})}a(mt,"strftime");function bt(r){let t;return function(){if(t)return t;if("Intl"in window)try{return t=new Intl.DateTimeFormat(void 0,r),t}catch(e){if(!(e instanceof RangeError))throw e}}}a(bt,"makeFormatter");var B=null,di=bt({day:"numeric",month:"short"});function pi(){if(B!==null)return B;let r=di();return r?(B=!!r.format(new Date(0)).match(/^\d/),B):!1}a(pi,"isDayFirst");var X=null,hi=bt({day:"numeric",month:"short",year:"numeric"});function ui(){if(X!==null)return X;let r=hi();return r?(X=!!r.format(new Date(0)).match(/\d,/),X):!0}a(ui,"isYearSeparator");function fi(r){return new Date().getUTCFullYear()===r.getUTCFullYear()}a(fi,"isThisYear");function mi(r,t){if("Intl"in window&&"RelativeTimeFormat"in window.Intl)try{return new Intl.RelativeTimeFormat(r,t)}catch(e){if(!(e instanceof RangeError))throw e}}a(mi,"makeRelativeFormat");function bi(r){let t=r.closest("[lang]");return t instanceof window.HTMLElement&&t.lang?t.lang:"default"}a(bi,"localeFromElement");var W=class{constructor(t,e){this.date=t,this.locale=e}toString(){let t=this.timeElapsed();if(t)return t;let e=this.timeAhead();return e||`on ${this.formatDate()}`}get value(){return this.date}timeElapsed({date:t=this.date,locale:e=this.locale}={}){let i=new Date().getTime()-t.getTime(),o=Math.round(i/1e3),s=Math.round(o/60),n=Math.round(s/60),c=Math.round(n/24);return i>=0&&c<30?this.timeAgoFromMs({ms:i,date:t,locale:e}):null}timeAhead({date:t=this.date,locale:e=this.locale}={}){let i=t.getTime()-new Date().getTime(),o=Math.round(i/1e3),s=Math.round(o/60),n=Math.round(s/60),c=Math.round(n/24);return i>=0&&c<30?this.timeUntil({date:t,locale:e}):null}timeAgo({date:t=this.date,locale:e=this.locale}={}){let i=new Date().getTime()-t.getTime();return this.timeAgoFromMs({ms:i,date:t,locale:e})}timeAgoFromMs({ms:t,locale:e=this.locale}={}){let i=Math.round(t/1e3),o=Math.round(i/60),s=Math.round(o/60),n=Math.round(s/24),c=Math.round(n/30),l=Math.round(c/12);return t<0||i<10?w(e,0,"second"):i<45?w(e,-i,"second"):i<90||o<45?w(e,-o,"minute"):o<90||s<24?w(e,-s,"hour"):s<36||n<30?w(e,-n,"day"):c<12?w(e,-c,"month"):(c<18,w(e,-l,"year"))}timeUntil({date:t=this.date,locale:e=this.locale}={}){let i=t.getTime()-new Date().getTime();return this.timeUntilFromMs({ms:i,locale:e})}timeUntilFromMs({ms:t,locale:e=this.locale}={}){let i=Math.round(t/1e3),o=Math.round(i/60),s=Math.round(o/60),n=Math.round(s/24),c=Math.round(n/30),l=Math.round(c/12);return c>=18||c>=12?w(e,l,"year"):n>=45||n>=30?w(e,c,"month"):s>=36||s>=24?w(e,n,"day"):o>=90||o>=45?w(e,s,"hour"):i>=90||i>=45?w(e,o,"minute"):i>=10?w(e,i,"second"):w(e,0,"second")}formatDate({date:t=this.date}={}){let e=pi()?"%e %b":"%b %e";return fi(t)||(e+=ui()?", %Y":" %Y"),mt(t,e)}formatTime({date:t=this.date}={}){let e=vi();return e?e.format(t):mt(t,"%l:%M%P")}};a(W,"RelativeTime");function w(r,t,e){let i=mi(r,{numeric:"auto"});return i?i.format(t,e):gi(t,e)}a(w,"formatRelativeTime");function gi(r,t){if(r===0)switch(t){case"year":case"quarter":case"month":case"week":return`this ${t}`;case"day":return"today";case"hour":case"minute":return`in 0 ${t}s`;case"second":return"now"}else if(r===1)switch(t){case"year":case"quarter":case"month":case"week":return`next ${t}`;case"day":return"tomorrow";case"hour":case"minute":case"second":return`in 1 ${t}`}else if(r===-1)switch(t){case"year":case"quarter":case"month":case"week":return`last ${t}`;case"day":return"yesterday";case"hour":case"minute":case"second":return`1 ${t} ago`}else if(r>1)switch(t){case"year":case"quarter":case"month":case"week":case"day":case"hour":case"minute":case"second":return`in ${r} ${t}s`}else if(r<-1)switch(t){case"year":case"quarter":case"month":case"week":case"day":case"hour":case"minute":case"second":return`${-r} ${t}s ago`}throw new RangeError(`Invalid unit argument for format() '${t}'`)}a(gi,"formatEnRelativeTime");var gt=class extends li{render(){let t=this.props.date||"",e=this.props.locale||bi(this);return typeof t=="string"&&(t=this.props.date=new Date(this.props.date)),t.toString()==="Invalid Date"&&(t=new Date),this.props.refresh&&(this.interval=setInterval(()=>{this.reRender(o=>({...o,date:t}))},+this.props.refresh)),new W(t,e).toString()}};a(gt,"TonicRelativeTime");var vi=bt({hour:"numeric",minute:"2-digit"});fe.exports={TonicRelativeTime:gt,RelativeTime:W}});var ge=v((qo,be)=>{var yi=y(),S=class extends yi{constructor(){super();if(S.patched)return;S.patched=!0;let t=a(function(e){let i=window.history[e];return function(...o){let s=i.call(this,...o);return window.dispatchEvent(new window.Event(e.toLowerCase())),S.route(),s}},"patchEvent");window.addEventListener("popstate",e=>S.route()),window.history.pushState=t("pushState"),window.history.replaceState=t("replaceState")}static route(t,e){t=t||[...document.getElementsByTagName("tonic-router")];let i=[],o=null,s=!1;S.props={};for(let n of t){let c=n.getAttribute("path");if(n.removeAttribute("match"),!c){o=n,o.reRender&&o.reRender();continue}let u=S.matcher(c,i).exec(window.location.pathname);u?(n.setAttribute("match",!0),s=!0,u.slice(1).forEach((d,m)=>{S.props[i[m].name]=d})):n.removeAttribute("match"),e||n.reRender&&n.reRender()}!e&&!s&&o&&(o.setAttribute("match",!0),o.reRender&&o.reRender())}willConnect(){let t=this.getAttribute("id");this.id=t||this.getAttribute("path"),this.template=document.createElement("template"),this.template.innerHTML=this.innerHTML,S.route([this],!0)}updated(){this.hasAttribute("match")&&this.dispatchEvent(new window.Event("match"))}render(){return this.hasAttribute("match")?(this.state=S.props,this.template.content):""}};a(S,"TonicRouter");S.matcher=(()=>{let r="/",t="./",e=new RegExp(["(\\\\.)","(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?"].join("|"),"g");function i(h,b){let f=[],x=0,k=0,g="",$=b&&b.delimiter||r,N=b&&b.delimiters||t,A=!1,q;for(;(q=e.exec(h))!==null;){let D=q[0],E=q[1],C=q.index;if(g+=h.slice(k,C),k=C+D.length,E){g+=E[1],A=!0;continue}let L="",j=h[k],Pe=q[2],Be=q[3],Xe=q[4],H=q[5];if(!A&&g.length){let J=g.length-1;N.indexOf(g[J])>-1&&(L=g[J],g=g.slice(0,J))}g&&(f.push(g),g="",A=!1);let We=L!==""&&j!==void 0&&j!==L,Ue=H==="+"||H==="*",Ge=H==="?"||H==="*",_t=L||$,zt=Be||Xe;f.push({name:Pe||x++,prefix:L,delimiter:_t,optional:Ge,repeat:Ue,partial:We,pattern:zt?s(zt):"[^"+o(_t)+"]+?"})}return(g||k<h.length)&&f.push(g+h.substr(k)),f}a(i,"parse");function o(h){return h.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}a(o,"escapeString");function s(h){return h.replace(/([=!:$/()])/g,"\\$1")}a(s,"escapeGroup");function n(h){return h&&h.sensitive?"":"i"}a(n,"flags");function c(h,b){if(!b)return h;let f=h.source.match(/\((?!\?)/g);if(f)for(let x=0;x<f.length;x++)b.push({name:x,prefix:null,delimiter:null,optional:!1,repeat:!1,partial:!1,pattern:null});return h}a(c,"regexpToRegexp");function l(h,b,f){let x=[];for(let k=0;k<h.length;k++)x.push(m(h[k],b,f).source);return new RegExp("(?:"+x.join("|")+")",n(f))}a(l,"arrayToRegexp");function u(h,b,f){return d(i(h,f),b,f)}a(u,"stringToRegexp");function d(h,b,f){f=f||{};let x=f.strict,k=f.end!==!1,g=o(f.delimiter||r),$=f.delimiters||t,N=[].concat(f.endsWith||[]).map(o).concat("$").join("|"),A="",q=h.length===0;for(let D=0;D<h.length;D++){let E=h[D];if(typeof E=="string")A+=o(E),q=D===h.length-1&&$.indexOf(E[E.length-1])>-1;else{let C=o(E.prefix),L=E.repeat?"(?:"+E.pattern+")(?:"+C+"(?:"+E.pattern+"))*":E.pattern;b&&b.push(E),E.optional?E.partial?A+=C+"("+L+")?":A+="(?:"+C+"("+L+"))?":A+=C+"("+L+")"}}return k?(x||(A+="(?:"+g+")?"),A+=N==="$"?"$":"(?="+N+")"):(x||(A+="(?:"+g+"(?="+N+"))?"),q||(A+="(?="+g+"|"+N+")")),new RegExp("^"+A,n(f))}a(d,"tokensToRegExp");function m(h,b,f){return h instanceof RegExp?c(h,b):Array.isArray(h)?l(h,b,f):u(h,b,f)}return a(m,"pathToRegexp"),m})();be.exports={TonicRouter:S}});var ye=v((Co,ve)=>{var xi=y(),M=class extends xi{defaults(){return{disabled:!1,invalid:!1,iconArrow:M.svg.default(),width:"250px",radius:"2px"}}static stylesheet(){return`
...
`);ve.exports={TonicSelect:M}});var we=v((Lo,xe)=>{var wi=y(),vt=class extends wi{static stylesheet(){return`
    ...
    `}};a(vt,"TonicSprite");xe.exports={TonicSprite:vt}});var $e=v((Io,ke)=>{var U=y(),G=class extends U{render(){return this.props.width&&(this.style.width=this.props.width),this.html`
      ${this.elements}
    ...
    `}start(){this.dragging=!0,this.setAttribute("dragging",!0)}cancel(){this.dragging=!1,this.removeAttribute("dragging")}willConnect(){this.updated()}hide(t){this[t].hidden||this.toggle(t,!1)}show(t){!this[t].hidden||this.toggle(t,!0)}toggle(t,e){let{meta:i}=this.state;typeof e=="boolean"&&e===!1&&delete i[t];let o=i[t],s="",n="";if(this.props.type==="vertical"?(s=t==="left"?"right":"left",n="width"):(s=t==="top"?"bottom":"top",n="height"),!o&&!e){i[t]={[t]:this[t].style[n],[s]:this[s].style[n],handle:this.handle.style.display},this[t].style[n]=0,this[s].style[n]="100%",this.handle.style.display="none";return}o&&(this[t].style[n]=o[t],this[s].style[n]=o[s],this.handle.style.display=o.handle,delete i[t])}connected(){this.handle=this.querySelector(`#${this.handleId}`),this.props.type==="vertical"?(this.left=this.elements[0],this.right=this.elements[1],this.handle.style.left=this.left.getAttribute("width")):(this.top=this.elements[0],this.bottom=this.elements[1],this.handle.style.top=this.top.getAttribute("height"))}afterResize(){clearTimeout(this.timeout),this.timeout=setTimeout(()=>{this.dispatchEvent(new window.CustomEvent("resize",{bubbles:!0}))},64)}updated(){this.cancel()}disconnected(){this.handle=null,this.left=null,this.right=null,this.top=null,this.bottom=null}mousemove(t){if(!this.dragging)return;let{x:e,y:i}=this.getBoundingClientRect(),o=this.offsetWidth,s=this.offsetHeight;this.lastX=t.clientX+1,this.lastY=t.clientY-1;let n=parseInt(this.props.max,10)||25,c=parseInt(this.props.min,10)||25;if(this.props.type==="vertical"){this.left=this.elements[0],this.right=this.elements[1];let d=t.clientX-e;d>=o-n&&(d=o-n),d<=c&&(d=c);let m=d/o*100;this.left.style.width=m+"%",this.handle.style.left=m+"%",this.right.style.width=100-m+"%",this.afterResize();return}this.top=this.elements[0],this.bottom=this.elements[1];let l=t.clientY-i;l>=s-n&&(l=s-n),l<=c&&(l=c);let u=l/s*100;u<=100-5&&(this.top.style.height=u+"%",this.handle.style.top=u+"%",this.bottom.style.height=100-u+"%",this.afterResize())}mouseenter(t){t.buttons===0&&this.cancel()}mouseleave(t){t.buttons===0&&this.cancel()}mousedown(t){let e=U.match(t.target,".tonic--split-handle");e&&e.parentElement===this&&(this.handle=e,this.start())}mouseup(t){this.cancel()}render(){let t=["tonic--split-handle",`tonic--split-${this.props.type}`].join(" ");return this.html`
      ...
      ${this.elements[1]}
    `}};a(wt,"TonicSplit");ke.exports={TonicSplit:wt,TonicSplitLeft:G,TonicSplitRight:yt,TonicSplitTop:Z,TonicSplitBottom:xt}});var Se=v((_o,Ae)=>{var F=y(),Ee=window.CustomEvent,kt=class extends F{constructor(t){super(t);this._setVisibilitySynchronously=!1,this.panels={}}static stylesheet(){return`
    ...
    `}styles(){let{width:t=this.state.width,height:e=this.state.height,radius:i,resize:o}=this.props;return{textarea:{width:t,height:e,borderRadius:i,resize:o}}}get value(){return this.querySelector("textarea").value}set value(t){this.querySelector("textarea").value=t}setValid(){let t=this.querySelector("textarea");!t||(t.setCustomValidity(""),t.removeAttribute("invalid"))}setInvalid(t){let e=this.querySelector("textarea");if(!e)return;this.setAttribute("edited",!0),this.state.edited=!0,e.setCustomValidity(t),window.requestAnimationFrame(()=>{e.setAttribute("invalid",t)});let i=this.querySelector(".tonic--invalid span");!i||(i.textContent=t)}renderLabel(){return typeof this.props.label=="undefined"?"":this.html`
      ...
      >${this.props.label}</label>
    `}willConnect(){let{value:t,persistSize:e}=this.props;if(this.props.value=typeof t=="undefined"?this.textContent:t,e==="true"){let i=a(o=>this.mutate(o.pop()),"cb");this.observer=new window.MutationObserver(i).observe(this,{attributes:!0,subtree:!0,attributeFilter:["style"]})}}disconnected(){this.observer&&this.observer.disconnect()}keyup(t){if(!this.props.pattern)return;this.regex||(this.regex=new RegExp(this.props.pattern)),t.target.value.trim().match(this.regex)?this.setValid():this.setInvalid("Invalid")}render(){let{ariaLabelledby:t,autofocus:e,cols:i,height:o,disabled:s,label:n,maxlength:c,minlength:l,name:u,placeholder:d,readonly:m,required:h,rows:b,spellcheck:f,tabindex:x,theme:k,width:g}=this.props;t&&this.removeAttribute("ariaLabelled"),g&&(this.style.width=g),o&&(this.style.height=o),x&&this.removeAttribute("tabindex"),k&&this.classList.add(`tonic--theme--${k}`),u&&this.removeAttribute("name");let $=this.props.errorMessage||"Invalid";return this.props.value==="undefined"&&(this.props.value=""),this.state.edited&&this.setAttribute("edited",!0),this.html`
      <div class="tonic--wrapper">
        ${this.renderLabel()}
        <textarea ... ${{styles:"textarea",id:`tonic--textarea_${this.props.id}`,"aria-label":n,"aria-labelledby":t,cols:i,disabled:s==="true",maxlength:c,minlength:l,name:u,placeholder:d,rows:b,spellcheck:f,tabindex:x,autofocus:e,required:h,readonly:m}}>${this.props.value}</textarea>
        <div class="tonic--invalid">
          <span id="tonic--error-${this.props.id}">${$}</span>
        </div>
      </div>
    `}};a(At,"TonicTextarea");qe.exports={TonicTextarea:At}});var Ie=v((Mo,Le)=>{var $i=y(),I=class extends $i{connected(){let t=this.props.for,e=document.getElementById(t),i=a(s=>{clearTimeout(I.timers[t]),I.timers[t]=setTimeout(()=>this.hide(),256)},"leave"),o=a(s=>{clearTimeout(I.timers[t]),this.show(e)},"enter");if(!e){console.warn("Broken tooltip for: "+t);return}e.addEventListener("mouseleave",i),e.addEventListener("mousemove",o),e.addEventListener("mouseenter",o),this.addEventListener("mouseenter",s=>{clearTimeout(I.timers[t])}),this.addEventListener("mouseleave",i)}defaults(t){return{width:"auto",height:"auto"}}static stylesheet(){return`
    ...
    `}};a(I,"TonicTooltip");I.timers={};Le.exports={TonicTooltip:I}});var Me=v((Ro,ze)=>{var _e=y(),St=class extends _e{defaults(){return{display:"true"}}static stylesheet(){return`
    ...
    `}};a(St,"TonicToasterInline");ze.exports={TonicToasterInline:St}});var De=v(Ne=>{var Re=y(),qt=class extends Re{defaults(){return{position:"center"}}static stylesheet(){return`
      tonic-toaster * {
        box-sizing: border-box;
      }
    ...
    `}};a(Ct,"TonicToggle");Ve.exports={TonicToggle:Ct}});var Te=v((Vo,He)=>{var Lt;try{Lt=y()}catch(r){throw console.error("Missing dependency. Try `npm install @operatortc/tonic`."),r}var Oe=Lt.version,Ai=Oe?Oe.split(".")[0]:"0";if(parseInt(Ai,10)<12)throw console.error("Out of date dependency. Try `npm install @operatortc/tonic@12`."),new Error("Invalid Tonic version. requires at least v12");var{TonicAccordion:Si,TonicAccordionSection:qi}=Dt(),{TonicBadge:Ci}=jt(),{TonicButton:Li}=Yt(),{TonicChart:Ii}=Ht(),{TonicCheckbox:_i}=Pt(),{TonicDialog:zi}=at(),{TonicForm:Mi}=Ut(),{TonicIcon:Ri}=Zt(),{TonicInput:Ni}=Jt(),{TonicLoader:Di}=te(),{TonicPanel:Vi}=ie(),{TonicPopover:ji}=ne(),{TonicProfileImage:Oi}=ae(),{TonicProgressBar:Yi}=le(),{TonicRange:Fi}=pe(),{TonicRelativeTime:Hi}=me(),{TonicRouter:Ti}=ge(),{TonicSelect:Pi}=ye(),{TonicSprite:Bi}=we(),{TonicSplit:Xi,TonicSplitLeft:Wi,TonicSplitRight:Ui,TonicSplitTop:Gi,TonicSplitBottom:Zi}=$e(),{TonicTabs:Ki,TonicTab:Ji,TonicTabPanel:Qi}=Se(),{TonicTextarea:to}=Ce(),{TonicTooltip:eo}=Ie(),{TonicToasterInline:io}=Me(),{TonicToaster:oo}=De(),{TonicToggle:so}=je(),Ye=!1;He.exports=Fe;Fe.Tonic=Lt;function Fe(r){Ye||(Ye=!0,r.add(Si),r.add(qi),r.add(Ci),r.add(Li),r.add(Ii),r.add(_i),r.add(zi),r.add(Mi),r.add(Ni),r.add(Ri),r.add(Di),r.add(Vi),r.add(ji),r.add(Oi),r.add(Yi),r.add(Fi),r.add(Hi),r.add(Ti),r.add(Pi),r.add(Bi),r.add(Xi),r.add(Wi),r.add(Ui),r.add(Gi),r.add(Zi),r.add(Qi),r.add(Ji),r.add(Ki),r.add(to),r.add(eo),r.add(io),r.add(oo),r.add(so))}a(Fe,"components")});var R=y(),no=Te();no(R);window.addEventListener("contextmenu",r=>{process.debug||r.preventDefault()});window.addEventListener("menuItemSelected",r=>{let{title:t,parent:e}=r.detail;if(t)switch(document.querySelector("#menu-selection").value=r.detail.title,t.toLowerCase()==="quit"&&system.exit(0),e.toLowerCase()){case"edit":switch(t.toLowerCase()){case"cut":{document.execCommand("cut");break}case"copy":{document.execCommand("copy");break}case"paste":{document.execCommand("paste");break}case"select all":{document.activeElement&&document.activeElement.select?document.activeElement.select():document.getSelection().extend(document.activeElement);break}case"delete":{if(document.activeElement&&document.activeElement.value&&"selectionStart"in document.activeElement&&"selectionEnd"in document.activeElement){let{selectionStart:i,selectionEnd:o,value:s}=document.activeElement;document.activeElement.value=s.slice(0,i).concat(s.slice(o))}break}}}});window.addEventListener("keyup",async r=>{r.ctrlKey&&r.key==="q"&&system.exit(0)});window.addEventListener("click",async r=>{let t=R.match(r.target,"#externalLink");!t||(r.preventDefault(),await system.openExternal(t.props.url))});window.addEventListener("data",r=>{if(r.detail.env){console.log(r);return}if(r.detail.size!==r.detail.sending.length)throw new Error("Not aligned: detail size not accurate");console.log(`received ${r.detail.size} characters`),K.setHeader(`${r.detail.counter} messages received`)});var It=class extends R{render(){return this.html`
      <h1>${this.props.message}</h1>
    `}};a(It,"AppHeader");R.add(It);var K=class extends R{static setHeader(t){document.querySelector("app-header").reRender({message:t})}async click(t){let e=R.match(t.target,"[data-event]");if(!e)return;let{event:i}=e.dataset;i==="open"&&(this.querySelector("#opened").value=await system.dialog({})),i==="save"&&(this.querySelector("#opened").value=await system.dialog({type:"save",defaultPath:"test.txt"})),i==="restart"&&system.send({restart:!0}),i==="showInspector"&&system.showInspector()}async input(t){if(!R.match(t.target,"tonic-input"))return;let i;try{let o={input:t.target.value};i=await system.send(o)}catch(o){console.log(o.message)}this.querySelector("#response").value=i.received.input}async contextmenu(t){if(!R.match(t.target,".context-menu"))return;t.preventDefault();let i=await system.setContextMenu({Download:"d",Wizard:"w","---":"",Inspect:"i"});i.title==="Inspect",i.title&&(document.querySelector("#menu-selection").value=i.title)}async render(){return this.html`
      <app-header>
      </app-header>
    ...
    `}};a(K,"AppContainer");function ro(r){let t,e;document.body.addEventListener("dragover",()=>{if(clearTimeout(e),t){t.style.zIndex=1e4,document.body.appendChild(t);return}t=document.createElement("textarea"),document.body.appendChild(t),t.style.opacity=0,t.style.position="fixed",t.style.top="0px",t.style.left="0px",t.style.right="0px",t.style.bottom="0px",t.style.zIndex=1e4,t.addEventListener("input",()=>{t.style.zIndex=-1,r&&r(t.value.split(`
`)),t.value="",document.body.removeChild(t)})}),document.body.addEventListener("dragleave",()=>{e=setTimeout(()=>{t.style.zIndex=-1,document.body.removeChild(t)},128)})}a(ro,"setupDrop");window.onload=async()=>{R.add(K),ro(r=>{console.log(r)}),document.body.addEventListener("dragstart",r=>{let t=`OPKIT_${Date.now()}`;r.dataTransfer.setData("text/plain",t)})};})();
