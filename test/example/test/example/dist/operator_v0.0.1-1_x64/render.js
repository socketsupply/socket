...
`),null,!1):this._prop(n);case"[object Object]":case"[object Function]":return this._prop(n);case"[object NamedNodeMap]":return this._prop(h._normalizeAttrs(n));case"[object Number]":return`${n}__float`;case"[object String]":return h.escape(n);case"[object Boolean]":return`${n}__boolean`;case"[object Null]":return`${n}__null`;case"[object HTMLElement]":return this._placehold([n])}return typeof n=="object"&&n&&n.nodeType===1&&typeof n.cloneNode=="function"?this._placehold([n]):n},"refs"),o=[];for(let n=0;n<t.length-1;n++)o.push(t[n],i(e[n]));o.push(t[t.length-1]);let s=o.join("").replace(h.SPREAD,(n,a)=>{let l=h._data[a.split("__")[1]][a];return Object.entries(l).map(([u,d])=>{let f=u.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();return d===!0?f:d?`${f}="${h.escape(String(d))}"`:""}).filter(Boolean).join(" ")});return new Y(s,t,!1)}scheduleReRender(t){return this.pendingReRender?this.pendingReRender:(this.pendingReRender=new Promise(e=>setTimeout(()=>{if(!this.isInDocument(this.shadowRoot||this))return;let i=this._set(this.shadowRoot||this,this.render);if(this.pendingReRender=null,i&&i.then)return i.then(()=>{this.updated&&this.updated(t),e()});this.updated&&this.updated(t),e()},0)),this.pendingReRender)}reRender(t=this.props){let e={...this.props};return this.props=typeof t=="function"?t(e):t,this.scheduleReRender(e)}handleEvent(t){this[t.type](t)}_drainIterator(t,e){return e.next().then(i=>{if(this._set(t,null,i.value),!i.done)return this._drainIterator(t,e)})}_set(t,e,i=""){for(let o of t.querySelectorAll(h._tags)){if(!o.isTonicComponent)continue;let s=o.getAttribute("id");!s||!h._refIds.includes(s)||(h._states[s]=o.state)}if(e instanceof h.AsyncFunction)return e.call(this).then(o=>this._apply(t,o));if(e instanceof h.AsyncFunctionGenerator)return this._drainIterator(t,e.call(this));e===null?this._apply(t,i):e instanceof Function&&this._apply(t,e.call(this)||"")}_apply(t,e){if(e&&e.isTonicTemplate?e=e.rawText:typeof e=="string"&&(e=h.escape(e)),typeof e=="string"){if(this.stylesheet&&(e=`<style nonce=${h.nonce||""}>${this.stylesheet()}</style>${e}`),t.innerHTML=e,this.styles){let s=this.styles();for(let n of t.querySelectorAll("[styles]"))for(let a of n.getAttribute("styles").split(/\s+/))Object.assign(n.style,s[a.trim()])}let i=h._children[this._id]||{},o=c((s,n)=>{if(s.nodeType===3){let l=s.textContent.trim();i[l]&&n(s,i[l],l)}let a=s.childNodes;if(!!a)for(let l=0;l<a.length;l++)o(a[l],n)},"walk");o(t,(s,n,a)=>{for(let l of n)s.parentNode.insertBefore(l,s);delete h._children[this._id][a],s.parentNode.removeChild(s)})}else t.innerHTML="",t.appendChild(e.cloneNode(!0))}connectedCallback(){this.root=this.shadowRoot||this,super.id&&!h._refIds.includes(super.id)&&h._refIds.push(super.id);let t=c(e=>e.replace(/-(.)/g,(i,o)=>o.toUpperCase()),"cc");for(let{name:e,value:i}of this.attributes){let o=t(e),s=this.props[o]=i;if(/__\w+__\w+__/.test(s)){let{1:n}=s.split("__");this.props[o]=h._data[n][s]}else if(/\d+__float/.test(s))this.props[o]=parseFloat(s,10);else if(s==="null__null")this.props[o]=null;else if(/\w+__boolean/.test(s))this.props[o]=s.includes("true");else if(/placehold:\w+:\w+__/.test(s)){let{1:n}=s.split(":");this.props[o]=h._children[n][s][0]}}if(this.props=Object.assign(this.defaults?this.defaults():{},this.props),this._id=this._id||h._createId(),this.willConnect&&this.willConnect(),!!this.isInDocument(this.root)){if(!this.preventRenderOnReconnect){this._source?this.innerHTML=this._source:this._source=this.innerHTML;let e=this._set(this.root,this.render);if(e&&e.then)return e.then(()=>this.connected&&this.connected())}this.connected&&this.connected()}}isInDocument(t){let e=t.getRootNode();return e===document||e.toString()==="[object ShadowRoot]"}disconnectedCallback(){this.disconnected&&this.disconnected(),delete h._data[this._id],delete h._children[this._id]}};c(h,"Tonic");h.prototype.isTonicComponent=!0;Object.assign(h,{_tags:"",_refIds:[],_data:{},_states:{},_children:{},_reg:{},_stylesheetRegistry:[],_index:0,version:zt().version,SPREAD:/\.\.\.\s?(__\w+__\w+__)/g,ESC:/["&'<>`/]/g,AsyncFunctionGenerator:async function*(){}.constructor,AsyncFunction:async function(){}.constructor,MAP:{'"':"&quot;","&":"&amp;","'":"&#x27;","<":"&lt;",">":"&gt;","`":"&#x60;","/":"&#x2F;"}});typeof J=="object"&&(J.exports=h)});var Nt=g((ao,Rt)=>{var F=y(),Q=class extends F{defaults(){return{multiple:!1}}static stylesheet(){return`
    ...
    `}};c(tt,"TonicAccordionSection");Rt.exports={TonicAccordion:Q,TonicAccordionSection:tt}});var Vt=g((co,Dt)=>{var Ze=y(),et=class extends Ze{defaults(){return{count:0}}get value(){return this.state.count}set value(t){this.state.count=t,this.reRender()}static stylesheet(){return`
      tonic-badge * {
    ...
    `}};c(it,"TonicButton");jt.exports={TonicButton:it}});var Ht=g((po,Ot)=>{var Je=y(),ot=class extends Je{static stylesheet(){return`
      tonic-chart {
        display: inline-block;
        position: relative;
      }
    ...
    `}};c(ot,"TonicChart");Ot.exports={TonicChart:ot}});var Pt=g((ho,Ft)=>{var Qe=y(),st=class extends Qe{constructor(){super();this._modified=!1}get value(){let t=this.state,e=this.props,i=typeof e.checked!="undefined"?e.checked:e.value,o=typeof t.checked!="undefined"?t.checked:t.value,s;return this._modified?s=typeof o!="undefined"?o:i:s=typeof i!="undefined"?i:o,s===!0||s==="true"}set value(t){this._setValue(t)}async _setValue(t){this._modified=!0,this.state._changing=!0;let e=t===!0||t==="true";this.state.checked=e,this.props.checked=e,await this.reRender()}defaults(){return{disabled:!1,size:"18px"}}static stylesheet(){return`
    ...
    `}show(){let t=this._getZIndex();this.appendChild(this.closeIcon),this.removeAttribute("hidden");let e=document.querySelector(".tonic--dialog--overlay");return e.classList.add("tonic--show"),this.style.zIndex=t+100,e.style.zIndex=t,new Promise(i=>{this.props.widthMobile&&document.body.clientWidth<500&&(this.props.width=this.props.widthMobile),this.style.width=this.props.width,this.style.height=this.props.height;let o=c(()=>{clearTimeout(s),i()},"done"),s=setTimeout(o,512);this.addEventListener("animationend",o,{once:!0}),this.classList.remove("tonic--hide"),this.classList.add("tonic--show"),this._escapeHandler=n=>{n.keyCode===27&&this.hide()},document.addEventListener("keyup",this._escapeHandler)})}hide(){let t=document.querySelector(".tonic--dialog--overlay");return t.classList.remove("tonic--show"),t.style.zIndex=-1,new Promise(e=>{this.style.zIndex=-1,document.removeEventListener("keyup",this._escapeHandler);let i=c(()=>{clearTimeout(o),this.setAttribute("hidden",!0),e()},"done"),o=setTimeout(i,512);this.addEventListener("animationend",i,{once:!0}),this.classList.remove("tonic--show"),this.classList.add("tonic--hide")})}event(t){let e=this;return{then(i){let o=c(n=>{n.keyCode===27&&i({})},"resolver"),s=c(n=>{let a=P.match(n.target,".tonic--dialog--close"),l=P.match(n.target,"[value]");if((a||l)&&(e.removeEventListener(t,s),document.removeEventListener("keyup",o)),a)return i({});l&&i({[n.target.value]:!0})},"listener");document.addEventListener("keyup",o),e.addEventListener(t,s)}}}click(t){P.match(t.target,".tonic--dialog--close")&&this.hide()}updated(){this.appendChild(this.closeIcon)}render(){return this.html`
      ${this.children}
    `}};c(nt,"TonicDialog");Bt.exports={TonicDialog:nt}});var Wt=g((fo,Tt)=>{var Xt=y(),_=class extends Xt{static isNumber(t){return!isNaN(Number(t))}static getPropertyValue(t,e){if(!e)return null;let i=e.split("."),o=t;for(let s of i){if(!o)return null;o=o[s]}return o}static setPropertyValue(t,e,i){if(!e)return;let o=e.split("."),s=t,n=o.pop();if(!!n){for(let a=0;a<o.length;a++){let l=o[a],u=o[a+1]||n;s[l]||(s[l]=_.isNumber(u)?[]:{}),s=s[l]}return s[n]=i,t}}setData(t){this.state=t}getData(){return this.value}getElements(){return[...this.querySelectorAll("[data-key]")]}get value(){let t=this.getElements();for(let e of t)_.setPropertyValue(this.state,e.dataset.key,e.value);return this.state}set value(t){if(typeof t!="object")return;let e=this.getElements();for(let i of e){let o=_.getPropertyValue(t,i.dataset.key);!o||(i.value=o)}this.state=t}setValid(){let t=this.getElements();for(let e of t)e.setValid&&(e.state.edited=!1,e.removeAttribute("edited"),e.setValid())}input(t){this.change(t)}change(t){let e=Xt.match(t.target,"[data-key]");!e||_.setPropertyValue(this.state,e.dataset.key,e.value)}validate({decorate:t=!0}={}){this.getData();let e=this.getElements(),i=!0;for(let o of e){if(!o.setInvalid)continue;let s="";o.tagName==="TONIC-INPUT"?s="input":o.tagName==="TONIC-TEXTAREA"?s="textarea":o.tagName==="TONIC-SELECT"?s="select":(o.tagName==="TONIC-CHECKBOX"||o.tagName==="TONIC-TOGGLE")&&(s="checkbox");let n=s?o.querySelector(s):o;if(!!n.checkValidity){n.checkValidity();for(let a in n.validity){if(a==="valid"||a==="customError"||!n.validity[a]){t&&o.setValid();continue}t&&o.setInvalid(o.props.errorMessage||"Required"),i=!1}}}return i}connected(){if(!this.props.fill)return;let t=this.getElements();for(let e of t){let i=e.dataset.key,o=_.getPropertyValue(this.state,i);e.value=o||e.value||""}}render(){return this.html`
      ${this.childNodes}
    `}};c(_,"TonicForm");Tt.exports={TonicForm:_}});var Gt=g((mo,Ut)=>{var ti=y(),at=class extends ti{defaults(){return{size:"25px",fill:"var(--tonic-primary, #333)"}}static stylesheet(){return`
      tonic-icon {
        vertical-align: middle;
      }
    ...
    `}setFocus(t){let e=this.querySelector("input");e.focus();try{e.setSelectionRange(t,t)}catch(i){console.warn(i)}}setupEvents(){let t=this.querySelector("input"),e=c(o=>{this.dispatchEvent(new window.CustomEvent(o,{bubbles:!0}))},"relay");t.addEventListener("focus",o=>{this.state.focus=!0,e("focus")}),t.addEventListener("blur",o=>{this.state.rerendering||(this.state.focus=!1,e("blur"))}),t.addEventListener("input",o=>{this._modified=!0,this.state.edited=!0,this.setAttribute("edited",!0),this.state.value=o.target.value,this.state.pos=o.target.selectionStart});let i=this.state;!i.focus||this.setFocus(i.pos)}updated(){this.setupEvents(),setTimeout(()=>{this.props.invalid?this.setInvalid(this.props.errorMessage):this.setValid()},32),this.state.rerendering=!1}async reRender(...t){return this.state.rerendering=!0,super.reRender(...t)}connected(){this.updated()}styles(){let{width:t,height:e,radius:i,padding:o}=this.props;return{wrapper:{width:t},input:{width:"100%",height:e,borderRadius:i,padding:o}}}render(){let{ariaInvalid:t,ariaLabelledby:e,disabled:i,height:o,label:s,max:n,maxlength:a,min:l,minlength:u,name:d,pattern:f,placeholder:p,position:b,readonly:m,required:x,spellcheck:v,tabindex:k,theme:z,title:R,type:A}=this.props;e&&this.removeAttribute("ariaLabelledby"),o&&(this.style.height=o),d&&this.removeAttribute("name"),k&&this.removeAttribute("tabindex"),z&&this.classList.add(`tonic--theme--${z}`);let S=this.value,N=this.props.errorMessage||this.props.errorMessage||"Invalid",$=["tonic--wrapper"];b&&$.push(`tonic--${b}`);let q=this.elements.length?this.props.id+"_datalist":null,L={ariaInvalid:t,ariaLabel:s,"aria-labelledby":e,disabled:i==="true",max:n,maxlength:a,min:l,minlength:u,name:d,pattern:f,placeholder:p,position:b,readonly:m==="true",required:x==="true",spellcheck:v,tabindex:k,title:R,value:S,list:q};this.state.edited&&this.setAttribute("edited",!0);let j="";return q&&(j=this.html`
        <datalist id="${q}">
          ${this.elements}
        </datalist>
      `),this.html`
    ...
    `}};c(ct,"TonicInput");Zt.exports={TonicInput:ct}});var Qt=g((go,Jt)=>{var ii=y(),lt=class extends ii{constructor(){super();this.attachShadow({mode:"open"})}stylesheet(){return`
      .outer {
        position: absolute;
        top: 0;
        bottom: 0;
    ...
    `}};c(lt,"TonicLoader");Jt.exports={TonicLoader:lt}});var ee=g((vo,te)=>{var{TonicDialog:oi}=rt(),dt=class extends oi{constructor(){super();this.classList.add("tonic--panel")}defaults(){return{position:"right"}}stylesheet(){let{width:t,position:e}=this.props,i=[0,t];return e!=="right"&&(i[1]=`-${t}`),`
    ...
    `}};c(dt,"TonicPanel");te.exports={TonicPanel:dt}});var se=g((yo,ie)=>{var oe=y(),pt=class extends oe{constructor(){super();let t=this.getAttribute("for"),e=document.getElementById(t);e.addEventListener("click",i=>this.show(e))}defaults(t){return{width:"auto",height:"auto",padding:"15px",margin:10,position:"bottomleft"}}static stylesheet(){return`
    ...
    `}};c(pt,"TonicPopover");ie.exports={TonicPopover:pt}});var re=g((xo,ne)=>{var si=y(),I=class extends si{get value(){return this.state.data||this.props.src}defaults(){return{src:I.svg.default(),size:"50px",radius:"5px"}}static stylesheet(){return`
      tonic-profile-image {
        display: inline-block;
      }
...
`);ne.exports={TonicProfileImage:I}});var ce=g((wo,ae)=>{var ni=y(),ht=class extends ni{set value(t){this.setProgress(t)}get value(){return typeof this.state.progress!="undefined"?this.state.progress:this.props.progress}defaults(){return{width:"280px",height:"15px",progress:0}}static stylesheet(){return`
      tonic-progress-bar {
        display: inline-block;
        user-select: none;
      }
    ...
    `}};c(ut,"TonicRange");le.exports={TonicRange:ut}});var fe=g(($o,pe)=>{var ai=y(),he=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],ue=["January","February","March","April","May","June","July","August","September","October","November","December"];function V(r){return`0${r}`.slice(-2)}c(V,"pad");function ft(r,t){let e=r.getDay(),i=r.getDate(),o=r.getMonth(),s=r.getFullYear(),n=r.getHours(),a=r.getMinutes(),l=r.getSeconds();return t.replace(/%([%aAbBcdeHIlmMpPSwyYZz])/g,u=>{let d;switch(u[1]){case"%":return"%";case"a":return he[e].slice(0,3);case"A":return he[e];case"b":return ue[o].slice(0,3);case"B":return ue[o];case"c":return r.toString();case"d":return V(i);case"e":return String(i);case"H":return V(n);case"I":return V(ft(r,"%l"));case"l":return String(n===0||n===12?12:(n+12)%12);case"m":return V(o+1);case"M":return V(a);case"p":return n>11?"PM":"AM";case"P":return n>11?"pm":"am";case"S":return V(l);case"w":return String(e);case"y":return V(s%100);case"Y":return String(s);case"Z":return d=r.toString().match(/\((\w+)\)$/),d?d[1]:"";case"z":return d=r.toString().match(/\w([+-]\d\d\d\d) /),d?d[1]:""}return""})}c(ft,"strftime");function mt(r){let t;return function(){if(t)return t;if("Intl"in window)try{return t=new Intl.DateTimeFormat(void 0,r),t}catch(e){if(!(e instanceof RangeError))throw e}}}c(mt,"makeFormatter");var B=null,ci=mt({day:"numeric",month:"short"});function li(){if(B!==null)return B;let r=ci();return r?(B=!!r.format(new Date(0)).match(/^\d/),B):!1}c(li,"isDayFirst");var T=null,di=mt({day:"numeric",month:"short",year:"numeric"});function pi(){if(T!==null)return T;let r=di();return r?(T=!!r.format(new Date(0)).match(/\d,/),T):!0}c(pi,"isYearSeparator");function hi(r){return new Date().getUTCFullYear()===r.getUTCFullYear()}c(hi,"isThisYear");function ui(r,t){if("Intl"in window&&"RelativeTimeFormat"in window.Intl)try{return new Intl.RelativeTimeFormat(r,t)}catch(e){if(!(e instanceof RangeError))throw e}}c(ui,"makeRelativeFormat");function fi(r){let t=r.closest("[lang]");return t instanceof window.HTMLElement&&t.lang?t.lang:"default"}c(fi,"localeFromElement");var X=class{constructor(t,e){this.date=t,this.locale=e}toString(){let t=this.timeElapsed();if(t)return t;let e=this.timeAhead();return e||`on ${this.formatDate()}`}get value(){return this.date}timeElapsed({date:t=this.date,locale:e=this.locale}={}){let i=new Date().getTime()-t.getTime(),o=Math.round(i/1e3),s=Math.round(o/60),n=Math.round(s/60),a=Math.round(n/24);return i>=0&&a<30?this.timeAgoFromMs({ms:i,date:t,locale:e}):null}timeAhead({date:t=this.date,locale:e=this.locale}={}){let i=t.getTime()-new Date().getTime(),o=Math.round(i/1e3),s=Math.round(o/60),n=Math.round(s/60),a=Math.round(n/24);return i>=0&&a<30?this.timeUntil({date:t,locale:e}):null}timeAgo({date:t=this.date,locale:e=this.locale}={}){let i=new Date().getTime()-t.getTime();return this.timeAgoFromMs({ms:i,date:t,locale:e})}timeAgoFromMs({ms:t,locale:e=this.locale}={}){let i=Math.round(t/1e3),o=Math.round(i/60),s=Math.round(o/60),n=Math.round(s/24),a=Math.round(n/30),l=Math.round(a/12);return t<0||i<10?w(e,0,"second"):i<45?w(e,-i,"second"):i<90||o<45?w(e,-o,"minute"):o<90||s<24?w(e,-s,"hour"):s<36||n<30?w(e,-n,"day"):a<12?w(e,-a,"month"):(a<18,w(e,-l,"year"))}timeUntil({date:t=this.date,locale:e=this.locale}={}){let i=t.getTime()-new Date().getTime();return this.timeUntilFromMs({ms:i,locale:e})}timeUntilFromMs({ms:t,locale:e=this.locale}={}){let i=Math.round(t/1e3),o=Math.round(i/60),s=Math.round(o/60),n=Math.round(s/24),a=Math.round(n/30),l=Math.round(a/12);return a>=18||a>=12?w(e,l,"year"):n>=45||n>=30?w(e,a,"month"):s>=36||s>=24?w(e,n,"day"):o>=90||o>=45?w(e,s,"hour"):i>=90||i>=45?w(e,o,"minute"):i>=10?w(e,i,"second"):w(e,0,"second")}formatDate({date:t=this.date}={}){let e=li()?"%e %b":"%b %e";return hi(t)||(e+=pi()?", %Y":" %Y"),ft(t,e)}formatTime({date:t=this.date}={}){let e=mi();return e?e.format(t):ft(t,"%l:%M%P")}};c(X,"RelativeTime");function w(r,t,e){let i=ui(r,{numeric:"auto"});return i?i.format(t,e):bi(t,e)}c(w,"formatRelativeTime");function bi(r,t){if(r===0)switch(t){case"year":case"quarter":case"month":case"week":return`this ${t}`;case"day":return"today";case"hour":case"minute":return`in 0 ${t}s`;case"second":return"now"}else if(r===1)switch(t){case"year":case"quarter":case"month":case"week":return`next ${t}`;case"day":return"tomorrow";case"hour":case"minute":case"second":return`in 1 ${t}`}else if(r===-1)switch(t){case"year":case"quarter":case"month":case"week":return`last ${t}`;case"day":return"yesterday";case"hour":case"minute":case"second":return`1 ${t} ago`}else if(r>1)switch(t){case"year":case"quarter":case"month":case"week":case"day":case"hour":case"minute":case"second":return`in ${r} ${t}s`}else if(r<-1)switch(t){case"year":case"quarter":case"month":case"week":case"day":case"hour":case"minute":case"second":return`${-r} ${t}s ago`}throw new RangeError(`Invalid unit argument for format() '${t}'`)}c(bi,"formatEnRelativeTime");var bt=class extends ai{render(){let t=this.props.date||"",e=this.props.locale||fi(this);return typeof t=="string"&&(t=this.props.date=new Date(this.props.date)),t.toString()==="Invalid Date"&&(t=new Date),this.props.refresh&&(this.interval=setInterval(()=>{this.reRender(o=>({...o,date:t}))},+this.props.refresh)),new X(t,e).toString()}};c(bt,"TonicRelativeTime");var mi=mt({hour:"numeric",minute:"2-digit"});pe.exports={TonicRelativeTime:bt,RelativeTime:X}});var be=g((Ao,me)=>{var gi=y(),E=class extends gi{constructor(){super();if(E.patched)return;E.patched=!0;let t=c(function(e){let i=window.history[e];return function(...o){let s=i.call(this,...o);return window.dispatchEvent(new window.Event(e.toLowerCase())),E.route(),s}},"patchEvent");window.addEventListener("popstate",e=>E.route()),window.history.pushState=t("pushState"),window.history.replaceState=t("replaceState")}static route(t,e){t=t||[...document.getElementsByTagName("tonic-router")];let i=[],o=null,s=!1;E.props={};for(let n of t){let a=n.getAttribute("path");if(n.removeAttribute("match"),!a){o=n,o.reRender&&o.reRender();continue}let u=E.matcher(a,i).exec(window.location.pathname);u?(n.setAttribute("match",!0),s=!0,u.slice(1).forEach((d,f)=>{E.props[i[f].name]=d})):n.removeAttribute("match"),e||n.reRender&&n.reRender()}!e&&!s&&o&&(o.setAttribute("match",!0),o.reRender&&o.reRender())}willConnect(){let t=this.getAttribute("id");this.id=t||this.getAttribute("path"),this.template=document.createElement("template"),this.template.innerHTML=this.innerHTML,E.route([this],!0)}updated(){this.hasAttribute("match")&&this.dispatchEvent(new window.Event("match"))}render(){return this.hasAttribute("match")?(this.state=E.props,this.template.content):""}};c(E,"TonicRouter");E.matcher=(()=>{let r="/",t="./",e=new RegExp(["(\\\\.)","(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?"].join("|"),"g");function i(p,b){let m=[],x=0,v=0,k="",z=b&&b.delimiter||r,R=b&&b.delimiters||t,A=!1,S;for(;(S=e.exec(p))!==null;){let N=S[0],$=S[1],q=S.index;if(k+=p.slice(v,q),v=q+N.length,$){k+=$[1],A=!0;continue}let L="",j=p[v],Pe=S[2],Be=S[3],Te=S[4],H=S[5];if(!A&&k.length){let K=k.length-1;R.indexOf(k[K])>-1&&(L=k[K],k=k.slice(0,K))}k&&(m.push(k),k="",A=!1);let Xe=L!==""&&j!==void 0&&j!==L,We=H==="+"||H==="*",Ue=H==="?"||H==="*",_t=L||z,It=Be||Te;m.push({name:Pe||x++,prefix:L,delimiter:_t,optional:Ue,repeat:We,partial:Xe,pattern:It?s(It):"[^"+o(_t)+"]+?"})}return(k||v<p.length)&&m.push(k+p.substr(v)),m}c(i,"parse");function o(p){return p.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}c(o,"escapeString");function s(p){return p.replace(/([=!:$/()])/g,"\\$1")}c(s,"escapeGroup");function n(p){return p&&p.sensitive?"":"i"}c(n,"flags");function a(p,b){if(!b)return p;let m=p.source.match(/\((?!\?)/g);if(m)for(let x=0;x<m.length;x++)b.push({name:x,prefix:null,delimiter:null,optional:!1,repeat:!1,partial:!1,pattern:null});return p}c(a,"regexpToRegexp");function l(p,b,m){let x=[];for(let v=0;v<p.length;v++)x.push(f(p[v],b,m).source);return new RegExp("(?:"+x.join("|")+")",n(m))}c(l,"arrayToRegexp");function u(p,b,m){return d(i(p,m),b,m)}c(u,"stringToRegexp");function d(p,b,m){m=m||{};let x=m.strict,v=m.end!==!1,k=o(m.delimiter||r),z=m.delimiters||t,R=[].concat(m.endsWith||[]).map(o).concat("$").join("|"),A="",S=p.length===0;for(let N=0;N<p.length;N++){let $=p[N];if(typeof $=="string")A+=o($),S=N===p.length-1&&z.indexOf($[$.length-1])>-1;else{let q=o($.prefix),L=$.repeat?"(?:"+$.pattern+")(?:"+q+"(?:"+$.pattern+"))*":$.pattern;b&&b.push($),$.optional?$.partial?A+=q+"("+L+")?":A+="(?:"+q+"("+L+"))?":A+=q+"("+L+")"}}return v?(x||(A+="(?:"+k+")?"),A+=R==="$"?"$":"(?="+R+")"):(x||(A+="(?:"+k+"(?="+R+"))?"),S||(A+="(?="+k+"|"+R+")")),new RegExp("^"+A,n(m))}c(d,"tokensToRegExp");function f(p,b,m){return p instanceof RegExp?a(p,b):Array.isArray(p)?l(p,b,m):u(p,b,m)}return c(f,"pathToRegexp"),f})();me.exports={TonicRouter:E}});var ve=g((Eo,ge)=>{var vi=y(),M=class extends vi{defaults(){return{disabled:!1,invalid:!1,iconArrow:M.svg.default(),width:"250px",radius:"2px"}}static stylesheet(){return`
...
`);ge.exports={TonicSelect:M}});var xe=g((So,ye)=>{var yi=y(),gt=class extends yi{static stylesheet(){return`
      tonic-sprite svg {
        visibility: hidden;
        height: 0;
      }
    ...
    `}};c(gt,"TonicSprite");ye.exports={TonicSprite:gt}});var ke=g((qo,we)=>{var W=y(),U=class extends W{render(){return this.props.width&&(this.style.width=this.props.width),this.html`
      ${this.elements}
    `}};c(U,"TonicSplitLeft");var G=class extends W{render(){return this.props.height&&(this.style.height=this.props.height),this.html`
      ${this.elements}
    `}};c(G,"TonicSplitTop");var vt=class extends U{};c(vt,"TonicSplitRight");var yt=class extends G{};c(yt,"TonicSplitBottom");var xt=class extends W{constructor(){super();this.left=null,this.right=null,this.top=null,this.bottom=null,this.handleId=`tonic--handle-${Math.random().toString().slice(2)}`,this.state.meta={}}static stylesheet(){return`
      tonic-split {
        position: absolute;
        top: 0;
        bottom: 0;
    ...
    `}start(){this.dragging=!0,this.setAttribute("dragging",!0)}cancel(){this.dragging=!1,this.removeAttribute("dragging")}willConnect(){this.updated()}toggle(t,e){let{meta:i}=this.state,o=i[t],s="",n="";if(this.props.type==="vertical"?(s=t==="left"?"right":"left",n="width"):(s=t==="top"?"bottom":"top",n="height"),!o&&!e){i[t]={[t]:this[t].style[n],[s]:this[s].style[n],handle:this.handle.style.display},this[t].style[n]=0,this[s].style[n]="100%",this.handle.style.display="none";return}o&&(this[t].style[n]=o[t],this[s].style[n]=o[s],this.handle.style.display=o.handle,delete i[t])}connected(){this.handle=this.querySelector(`#${this.handleId}`),this.props.type==="vertical"?(this.left=this.elements[0],this.right=this.elements[1],this.handle.style.left=this.left.getAttribute("width")):(this.top=this.elements[0],this.bottom=this.elements[1],this.handle.style.top=this.top.getAttribute("height"))}afterResize(){clearTimeout(this.timeout),this.timeout=setTimeout(()=>{this.dispatchEvent(new window.CustomEvent("resize",{bubbles:!0}))},64)}updated(){this.cancel()}disconnected(){this.handle=null,this.left=null,this.right=null,this.top=null,this.bottom=null}mousemove(t){if(!this.dragging)return;let{x:e,y:i}=this.getBoundingClientRect(),o=this.offsetWidth,s=this.offsetHeight,n=t.clientX>=this.lastX,a=t.clientY>=this.lastY;this.lastX=t.clientX+1,this.lastY=t.clientY-1;let l=parseInt(this.props.max,10)||25,u=parseInt(this.props.min,10)||25;if(this.props.type==="vertical"){if(n&&this.right.offsetWidth<=l)return this.cancel();if(!n&&this.left.offsetWidth<=u)return this.cancel();this.left=this.elements[0],this.right=this.elements[1];let b=(t.clientX-e)/o*100;this.left.style.width=b+"%",this.handle.style.left=b+"%",this.right.style.width=100-b+"%",this.afterResize();return}if(!a&&this.top.offsetHeight<=u)return this.cancel();if(a&&this.bottom.offsetHeight<=l)return this.cancel();this.top=this.elements[0],this.bottom=this.elements[1];let f=(t.clientY-i)/s*100;f<=100-5&&(this.top.style.height=f+"%",this.handle.style.top=f+"%",this.bottom.style.height=100-f+"%",this.afterResize())}mouseenter(t){this.cancel()}mouseleave(t){this.cancel()}mousedown(t){let e=W.match(t.target,".tonic--split-handle");e&&e.parentElement===this&&(this.handle=e,this.start())}mouseup(t){this.cancel()}render(){let t=["tonic--split-handle",`tonic--split-${this.props.type}`].join(" ");return this.html`
      ...
      ${this.elements[1]}
    `}};c(xt,"TonicSplit");we.exports={TonicSplit:xt,TonicSplitLeft:U,TonicSplitRight:vt,TonicSplitTop:G,TonicSplitBottom:yt}});var Ee=g((Lo,$e)=>{var O=y(),Ae=window.CustomEvent,wt=class extends O{constructor(t){super(t);this._setVisibilitySynchronously=!1,this.panels={}}static stylesheet(){return`
    ...
    `}};c(C,"TonicTooltip");C.timers={};Le.exports={TonicTooltip:C}});var Me=g((Io,_e)=>{var Ie=y(),Et=class extends Ie{defaults(){return{display:"true"}}static stylesheet(){return`
    ...
    `}};c(Et,"TonicToasterInline");_e.exports={TonicToasterInline:Et}});var Ne=g(ze=>{var Re=y(),St=class extends Re{defaults(){return{position:"center"}}static stylesheet(){return`
      tonic-toaster * {
        box-sizing: border-box;
      }
    ...
    `}};c(qt,"TonicToggle");De.exports={TonicToggle:qt}});var Fe=g((Ro,je)=>{var Lt;try{Lt=y()}catch(r){throw console.error("Missing dependency. Try `npm install @optoolco/tonic`."),r}var Ye=Lt.version,$i=Ye?Ye.split(".")[0]:"0";if(parseInt($i,10)<12)throw console.error("Out of date dependency. Try `npm install @optoolco/tonic@12`."),new Error("Invalid Tonic version. requires at least v12");var{TonicAccordion:Ai,TonicAccordionSection:Ei}=Nt(),{TonicBadge:Si}=Vt(),{TonicButton:qi}=Yt(),{TonicChart:Li}=Ht(),{TonicCheckbox:Ci}=Pt(),{TonicDialog:_i}=rt(),{TonicForm:Ii}=Wt(),{TonicIcon:Mi}=Gt(),{TonicInput:zi}=Kt(),{TonicLoader:Ri}=Qt(),{TonicPanel:Ni}=ee(),{TonicPopover:Di}=se(),{TonicProfileImage:Vi}=re(),{TonicProgressBar:ji}=ce(),{TonicRange:Yi}=de(),{TonicRelativeTime:Oi}=fe(),{TonicRouter:Hi}=be(),{TonicSelect:Fi}=ve(),{TonicSprite:Pi}=xe(),{TonicSplit:Bi,TonicSplitLeft:Ti,TonicSplitRight:Xi,TonicSplitTop:Wi,TonicSplitBottom:Ui}=ke(),{TonicTabs:Gi,TonicTab:Zi,TonicTabPanel:Ki}=Ee(),{TonicTextarea:Ji}=qe(),{TonicTooltip:Qi}=Ce(),{TonicToasterInline:to}=Me(),{TonicToaster:eo}=Ne(),{TonicToggle:io}=Ve(),Oe=!1;je.exports=He;He.Tonic=Lt;function He(r){Oe||(Oe=!0,r.add(Ai),r.add(Ei),r.add(Si),r.add(qi),r.add(Li),r.add(Ci),r.add(_i),r.add(Ii),r.add(zi),r.add(Mi),r.add(Ri),r.add(Ni),r.add(Di),r.add(Vi),r.add(ji),r.add(Yi),r.add(Oi),r.add(Hi),r.add(Fi),r.add(Pi),r.add(Bi),r.add(Ti),r.add(Xi),r.add(Wi),r.add(Ui),r.add(Ki),r.add(Zi),r.add(Gi),r.add(Ji),r.add(Qi),r.add(to),r.add(eo),r.add(io))}c(He,"components")});var D=y(),oo=Fe();oo(D);window.addEventListener("menuItemSelected",r=>{document.querySelector("#menu-selection").value=r.detail.title});window.addEventListener("themeChanged",r=>{let t=document.body.getAttribute("theme");document.body.setAttribute("theme",t==="dark"?"light":"dark")});window.addEventListener("data",r=>{console.log("ARBITRARY DATA",r.detail),Z.setHeader(`${r.detail.counter} messages received`)});var Ct=class extends D{render(){return this.html`
      <h1>${this.props.message}</h1>
    `}};c(Ct,"AppHeader");D.add(Ct);var Z=class extends D{static setHeader(t){document.querySelector("app-header").reRender({message:t})}async click(t){if(!D.match(t.target,"tonic-button"))return;let i=await dialog(t.target.value);this.querySelector("#opened").value=i.replace(",",`
`)}async input(t){if(!D.match(t.target,"tonic-input"))return;let i;try{let o={input:t.target.value};i=await invokeIPC(o)}catch(o){console.log(o.message)}this.querySelector("#response").value=i.received.input}async contextmenu(t){if(!D.match(t.target,".context-menu"))return;let i=await contextMenu({Download:"d",Wizard:"w",Share:"s"});document.querySelector("#menu-selection").value=i.title}render(){return this.html`
      <app-header>
      </app-header>
    ...
    `}};c(Z,"AppContainer");window.onload=async()=>{D.add(Z),dd.addEventListener("dragover",r=>(r.preventDefault(),!0)),dd.addEventListener("dragstart",r=>!0),dd.addEventListener("dragend",r=>{let t=event.dataTransfer.items;return!0})};})();
