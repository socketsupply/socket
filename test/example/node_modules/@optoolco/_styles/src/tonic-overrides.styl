body
  --tonic-body 'Inter', sans-serif // Body font
  --tonic-header 'Inter Black', sans-serif // Header font
  --tonic-subheader 'Inter Medium', sans-serif // Accent font
  --tonic-monospace 'FiraMono', monospace // Monospace font
...
tonic-button.danger
  --tonic-button-text: rgba(255, 255, 255, 1);
  --tonic-button-background: rgba(240, 100, 83, 1);
  --tonic-button-background-hover: rgba(255, 80, 55, 1);
  --tonic-button-background-focus: rgba(220, 80, 60, 1);

tonic-button.excited
  --tonic-button-text: rgba(255, 255, 255, 1);
  --tonic-button-background: rgba(133, 178, 116, 1);
  --tonic-button-background-hover: rgba(157, 218, 133, 1);
  --tonic-button-background-focus: rgba(113, 158, 93, 1);

tonic-button.outline
  --tonic-button-text rgba(255, 255, 255, 1)
  --tonic-button-background 
  --tonic-button-background-hover var(--tonic-primary)
  --tonic-button-background-focus transparent
